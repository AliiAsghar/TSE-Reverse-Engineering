...
public class IconCompatParcelizer {
    ...
    public static IconCompat read(gnb gnbVar) {
        Parcelable parcelable;
        IconCompat iconCompat = new IconCompat();
        iconCompat.b = gnbVar.a(iconCompat.b, 1);
        byte[] bArr = iconCompat.d;
        if (gnbVar.s(2)) {
            int readInt = gnbVar.d.readInt();
            if (readInt < 0) {
                bArr = null;
            } else {
                bArr = new byte[readInt];
                gnbVar.d.readByteArray(bArr);
            }
        }
        iconCompat.d = bArr;
        iconCompat.e = gnbVar.b(iconCompat.e, 3);
        iconCompat.f = gnbVar.a(iconCompat.f, 4);
        iconCompat.g = gnbVar.a(iconCompat.g, 5);
        iconCompat.h = (ColorStateList) gnbVar.b(iconCompat.h, 6);
        iconCompat.j = gnbVar.e(iconCompat.j, 7);
        iconCompat.k = gnbVar.e(iconCompat.k, 8);
    ...
    public static void write(IconCompat iconCompat, gnb gnbVar) {
        ...
        if (bArr != null) {
            gnbVar.p(2);
            gnbVar.d.writeInt(bArr.length);
            gnbVar.d.writeByteArray(bArr);
        }
        Parcelable parcelable = iconCompat.e;
        if (parcelable != null) {
            gnbVar.i(parcelable, 3);
        }
        int i2 = iconCompat.f;
        if (i2 != 0) {
            gnbVar.h(i2, 4);
