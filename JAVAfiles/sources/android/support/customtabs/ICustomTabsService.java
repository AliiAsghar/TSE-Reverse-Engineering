        ...
        public boolean onTransact(int i, Parcel parcel, Parcel parcel2, int i2) {
            ...
            switch (i) {
                ...
                case 3:
                    ...
                    return true;
                case 4:
                    boolean mayLaunchUrl = mayLaunchUrl(ICustomTabsCallback.Stub.asInterface(parcel.readStrongBinder()), (Uri) a.d(parcel, Uri.CREATOR), (Bundle) a.d(parcel, Bundle.CREATOR), parcel.createTypedArrayList(Bundle.CREATOR));
                    parcel2.writeNoException();
                ...
                case 14:
                    ...
                    return true;
                case 15:
                    prefetch(ICustomTabsCallback.Stub.asInterface(parcel.readStrongBinder()), (Uri) a.d(parcel, Uri.CREATOR), (Bundle) a.d(parcel, Bundle.CREATOR));
                    parcel2.writeNoException();
                    return true;
                case 16:
                    prefetchWithMultipleUrls(ICustomTabsCallback.Stub.asInterface(parcel.readStrongBinder()), parcel.createTypedArrayList(Uri.CREATOR), (Bundle) a.d(parcel, Bundle.CREATOR));
                    parcel2.writeNoException();
                    return true;
                default:
