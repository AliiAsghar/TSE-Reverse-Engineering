...
public class ActionBarContextView extends jf {
    ...
    public final void h(hm hmVar) {
        ...
        this.k = findViewById;
        findViewById.setOnClickListener(new jh(hmVar, 0));
        Menu a = hmVar.a();
        jq jqVar = this.d;
        if (jqVar != null) {
            jqVar.o();
        }
        this.d = new jq(getContext());
        this.d.q();
        ViewGroup.LayoutParams layoutParams = new ViewGroup.LayoutParams(-2, -1);
        ((ij) a).h(this.d, this.b);
        jq jqVar2 = this.d;
        ix ixVar = jqVar2.f;
        if (jqVar2.f == null) {
            jqVar2.f = (ix) jqVar2.d.inflate(R.layout.abc_action_menu_layout, (ViewGroup) this, false);
            jqVar2.f.a(jqVar2.c);
            jqVar2.i();
        }
        ix ixVar2 = jqVar2.f;
        if (ixVar != ixVar2) {
            ((ActionMenuView) ixVar2).h(jqVar2);
        }
        this.c = (ActionMenuView) ixVar2;
    ...
    public ActionBarContextView(Context context, AttributeSet attributeSet, int i) {
        ...
        ktk A = ktk.A(context, attributeSet, gc.d, i, 0);
        setBackground(A.p(0));
        this.p = A.n(5, 0);
        this.q = A.n(4, 0);
        this.e = A.m(3, 0);
        this.r = A.n(2, R.layout.abc_action_mode_close_item_material);
        A.t();
    }
}
