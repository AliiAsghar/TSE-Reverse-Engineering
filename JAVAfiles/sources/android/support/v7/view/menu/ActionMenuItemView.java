...
public class ActionMenuItemView extends AppCompatTextView implements View.OnClickListener, iw, jr {
    public im a;
    public ii b;
    public qdq c;
    ...
    public final void f(im imVar) {
        ...
        if (imVar.hasSubMenu() && this.f == null) {
            this.f = new hy(this);
        }
    }
    ...
    public final boolean onTouchEvent(MotionEvent motionEvent) {
        ml mlVar;
        if (this.a.hasSubMenu() && (mlVar = this.f) != null && mlVar.onTouch(this, motionEvent)) {
            return true;
        }
    ...
    public ActionMenuItemView(Context context, AttributeSet attributeSet, int i) {
        ...
        this.g = l();
        TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, gc.c, i, 0);
