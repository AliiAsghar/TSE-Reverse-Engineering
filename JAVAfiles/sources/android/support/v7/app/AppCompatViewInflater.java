...
public class AppCompatViewInflater {
    ...
    public kh a(Context context, AttributeSet attributeSet) {
        return new kh(context, attributeSet);
    }

    public kj b(Context context, AttributeSet attributeSet) {
    ...
    public ks d(Context context, AttributeSet attributeSet) {
    ...
    public final View f(Context context, String str, String str2) {
        String str3;
        vl vlVar = h;
        Constructor constructor = (Constructor) vlVar.get(str);
        if (constructor == null) {
            if (str2 != null) {
                try {
                    str3 = str2 + str;
