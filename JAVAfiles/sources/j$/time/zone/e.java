...
public final class e implements Serializable {
    ...
    private static Object a(LocalDateTime localDateTime, b bVar) {
        LocalDateTime t = bVar.t();
        if (bVar.a0()) {
            if (localDateTime.k0(t)) {
                return bVar.D();
            }
            if (localDateTime.k0(bVar.n())) {
                return bVar;
            }
            return bVar.y();
        }
    ...
    private b[] b(int i2) {
        ...
        if (timeZone != null) {
            ...
            long n = AbstractC0077h.n(LocalDateTime.l0(i2 - 1), this.b[0]);
            ...
            while (n < j3) {
                ...
                if (offset != timeZone.getOffset(j4 * 1000)) {
                    ...
                    if (c(n, k3) == i2) {
                        ...
                        bVarArr2[bVarArr2.length - 1] = new b(n, k2, k3);
                    }
                } else {
                    j2 = j3;
                    n = j4;
    ...
    private static int c(long j2, ZoneOffset zoneOffset) {
        return LocalDate.q0(p.f(j2 + zoneOffset.i0(), 86400)).j0();
    }
    ...
    private Object e(LocalDateTime localDateTime) {
        ...
        TimeZone timeZone = this.g;
        if (timeZone != null) {
            b[] b = b(localDateTime.i0());
            if (b.length == 0) {
                return k(timeZone.getOffset(AbstractC0077h.n(localDateTime, zoneOffsetArr[0]) * 1000));
            }
            int length = b.length;
            while (i2 < length) {
                b bVar = b[i2];
        ...
        if (length2 > 0 && localDateTime.j0(localDateTimeArr[localDateTimeArr.length - 1])) {
            b[] b2 = b(localDateTime.i0());
        ...
        if ((binarySearch & 1) == 0) {
            ...
            if (zoneOffset2.i0() > zoneOffset.i0()) {
