...
public final class p extends AbstractC0070a implements Serializable {
    ...
    static {
        p pVar = new p();
        o = pVar;
        AbstractC0070a.y(pVar, "Hijrah");
        AbstractC0070a.y(pVar, "islamic");
    }
                ...
                if (str.equals("Hijrah-umalqura")) {
                    if (this.e.equals("islamic-umalqura")) {
                        if (epochDay != 0) {
                            this.j = 15600;
                            this.h = epochDay;
                            int[] e0 = e0(epochDay, hashMap);
                            this.g = e0;
                            this.i = e0[3612];
                            for (int i2 = 1300; i2 < 1600; i2++) {
                                int m0 = m0(i2, 12);
                                this.m = Math.min(this.m, m0);
                                this.n = Math.max(this.n, m0);
                            }
                            this.f = true;
                            return;
                        }
    ...
    private int[] e0(int i, HashMap hashMap) {
    ...
    public final j$.time.temporal.p Q(ChronoField chronoField) {
        ...
        if (chronoField instanceof ChronoField) {
            switch (o.a[chronoField.ordinal()]) {
                case 1:
                    return j$.time.temporal.p.k(1L, this.k, this.l);
                case 2:
                    return j$.time.temporal.p.j(1L, this.n);
                case 3:
                    return j$.time.temporal.p.j(1L, 5L);
                case 4:
                case 5:
                    return j$.time.temporal.p.j(f0(0), f0(this.g.length - 1) - 1);
                case 6:
    ...
    public final boolean W(long j) {
        c0();
        if (j < f0(0) || j > f0(this.g.length - 1) - 1 || m0((int) j, 12) <= 354) {
            return false;
        }
        return true;
    }
    ...
    public final int d0(long j) {
        if (j >= f0(0) && j <= f0(this.g.length - 1) - 1) {
            return (int) j;
        }
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public final long h0(int i, int i2, int i3) {
        c0();
        if (i2 >= 1 && i2 <= 12) {
    ...
    public final int[] i0(int i) {
        ...
        if (i >= this.h && i < this.i) {
            ...
            return new int[]{f0(binarySearch), ((this.j + binarySearch) % 12) + 1, (i - this.g[binarySearch]) + 1};
        }
    ...
    public final InterfaceC0071b q(TemporalAccessor temporalAccessor) {
        ...
        return r.h0(this, temporalAccessor.y(ChronoField.EPOCH_DAY));
    }

    @Override // j$.time.chrono.AbstractC0070a
    public final InterfaceC0071b t() {
        return r.h0(this, LocalDate.o0(j$.time.b.c()).y(ChronoField.EPOCH_DAY));
    }
