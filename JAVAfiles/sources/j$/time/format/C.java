...
class C {
    ...
    private static Object b(TemporalField temporalField, Locale locale) {
        ...
        if (temporalField == ChronoField.ERA) {
            ...
            j$.nio.channels.c.e(hashMap, dateFormatSymbols2, locale);
            ...
            j$.nio.channels.c.d(hashMap, dateFormatSymbols3, locale);
    ...
    public String e(j$.time.chrono.m mVar, TemporalField temporalField, long j, H h, Locale locale) {
        if (mVar != j$.time.chrono.t.d && (temporalField instanceof ChronoField)) {
            return null;
        }
        return f(temporalField, j, h, locale);
    }

    public String f(TemporalField temporalField, long j, H h, Locale locale) {
    ...
    public Iterator g(j$.time.chrono.m mVar, TemporalField temporalField, H h, Locale locale) {
        if (mVar != j$.time.chrono.t.d && (temporalField instanceof ChronoField)) {
            return null;
        }
        return h(temporalField, h, locale);
    }

    public Iterator h(TemporalField temporalField, H h, Locale locale) {
        Object b2 = b(temporalField, locale);
        if (b2 instanceof B) {
            return ((B) b2).b(h);
        }
