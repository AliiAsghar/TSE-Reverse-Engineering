...
public class C0238t implements java.util.Map, Serializable, Map {
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public C0238t(java.util.Map map) {
        map.getClass();
        this.a = map;
    }
    ...
    /* JADX WARN: Type inference failed for: r0v2, types: [java.util.Set, j$.util.m] */
    @Override // java.util.Map
    public final java.util.Set entrySet() {
        if (this.c == null) {
            this.c = new C0103m(this.a.entrySet());
        }
        return this.c;
    }
