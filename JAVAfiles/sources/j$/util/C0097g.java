...
public class C0097g implements java.util.Collection, Serializable, Collection {
    private static final long serialVersionUID = 3053995032091335093L;
    final java.util.Collection a;
    final Serializable b;

    /* JADX INFO: Access modifiers changed from: package-private */
    public C0097g(java.util.Collection collection) {
        collection.getClass();
        this.a = collection;
        this.b = this;
    }
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public C0097g(java.util.Collection collection, Serializable serializable) {
        collection.getClass();
        this.a = collection;
        this.b = serializable;
    }
