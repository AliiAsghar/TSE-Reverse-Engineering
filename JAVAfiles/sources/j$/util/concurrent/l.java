...
public class l implements Map.Entry {
    ...
    public final boolean equals(Object obj) {
        ...
        Object obj2;
        Object obj3;
        if ((obj instanceof Map.Entry) && (key = (entry = (Map.Entry) obj).getKey()) != null && (value = entry.getValue()) != null && ((key == (obj2 = this.b) || key.equals(obj2)) && (value == (obj3 = this.c) || value.equals(obj3)))) {
            return true;
        }
        return false;
    }
