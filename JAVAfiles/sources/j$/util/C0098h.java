...
public class C0098h extends C0097g implements java.util.List, List {
    private static final long serialVersionUID = -7754090372962971524L;
    final java.util.List c;

    /* JADX INFO: Access modifiers changed from: package-private */
    public C0098h(java.util.List list) {
        super(list);
        this.c = list;
    }
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public C0098h(java.util.List list, Serializable serializable) {
