...
public final class C0221w2 extends A {
    final /* synthetic */ long m;
    final /* synthetic */ long n;

    /* JADX INFO: Access modifiers changed from: package-private */
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public C0221w2(A a, int i, long j, long j2) {
        super(a, i, 0);
        this.m = j;
        this.n = j2;
    }
    ...
    final I0 K(AbstractC0114b abstractC0114b, Spliterator spliterator, IntFunction intFunction) {
        ...
        if (C > 0 && spliterator.hasCharacteristics(16384)) {
            return AbstractC0219w0.F(abstractC0114b, AbstractC0219w0.C(abstractC0114b.F(), spliterator, this.m, this.n), true);
        }
        ...
        j$.util.V v = (j$.util.V) abstractC0114b.T(spliterator);
        long j4 = this.m;
        long j5 = this.n;
        if (j4 <= C) {
            if (j5 >= 0) {
        ...
        return AbstractC0219w0.F(this, new J3(v, j2, j), true);
    }
    ...
    final Spliterator L(AbstractC0114b abstractC0114b, Spliterator spliterator) {
        ...
        if (C > 0 && spliterator.hasCharacteristics(16384)) {
            j$.util.V v = (j$.util.V) abstractC0114b.T(spliterator);
            long j4 = this.m;
            return new A3(v, j4, AbstractC0219w0.B(j4, j3));
        }
        if (EnumC0143g3.ORDERED.y(abstractC0114b.G())) {
            invoke = new C0231y2(this, abstractC0114b, spliterator, new W(23), this.m, this.n).invoke();
            return ((I0) invoke).spliterator();
        }
        j$.util.V v2 = (j$.util.V) abstractC0114b.T(spliterator);
        long j5 = this.m;
        if (j5 <= C) {
            long j6 = C - j5;
            if (j3 >= 0) {
