...
public final class X3 extends AbstractC0130e0 {
    final /* synthetic */ IntPredicate m;

    /* JADX INFO: Access modifiers changed from: package-private */
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public X3(AbstractC0135f0 abstractC0135f0, int i, IntPredicate intPredicate) {
    ...
    final Spliterator L(AbstractC0114b abstractC0114b, Spliterator spliterator) {
        if (EnumC0143g3.ORDERED.y(abstractC0114b.G())) {
            return K(abstractC0114b, spliterator, new W(26)).spliterator();
        }
        return new e4((j$.util.Y) abstractC0114b.T(spliterator), this.m, 1);
    }

    /* JADX INFO: Access modifiers changed from: package-private */
    @Override // j$.util.stream.AbstractC0114b
    public final InterfaceC0182o2 N(int i, InterfaceC0182o2 interfaceC0182o2) {
        return new W3(this, interfaceC0182o2);
    }
}
