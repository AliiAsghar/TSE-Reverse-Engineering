...
abstract class p {
    ...
    public static o b(AbstractC0067i abstractC0067i, URI uri, String str, String str2) {
        byte b2;
        if (uri.isAbsolute()) {
            if (!uri.isOpaque()) {
                        ...
                        if (uri.getRawFragment() == null) {
                            if (uri.getRawQuery() == null) {
                                ...
                                if (length != 0) {
                                    ...
                                    return new o(abstractC0067i, new String(bArr, q.a()), str, str2);
                                }
    ...
    public static URI f(o oVar) {
        byte[] n = oVar.toAbsolutePath().n();
        StringBuilder sb = new StringBuilder("file:///");
        for (int i = 1; i < n.length; i++) {
            char c2 = (char) (n[i] & 255);
