...
public abstract class AbstractItemHierarchy {
    ...
    public final void a(int i) {
        int i2;
        if (i < 0) {
            Log.w("AbstractItemHierarchy", a.bV(i, "notifyItemRangeChanged: Invalid position="));
            return;
        }
    ...
    public AbstractItemHierarchy(Context context, AttributeSet attributeSet) {
        TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, ajvp.a);
