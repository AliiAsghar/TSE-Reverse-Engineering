...
public class Illustration extends FrameLayout {
    ...
    private final void a(AttributeSet attributeSet, int i) {
        ...
        if (attributeSet != null) {
            TypedArray obtainStyledAttributes = getContext().obtainStyledAttributes(attributeSet, ajvp.i, i, 0);
            this.g = obtainStyledAttributes.getFloat(0, brg.a);
    ...
    public final void onDraw(Canvas canvas) {
        if (this.b != null) {
            canvas.save();
            canvas.translate(brg.a, this.e.height());
            float f = this.f;
            canvas.scale(f, f, brg.a, brg.a);
            if (b(this.b, getLayoutDirection())) {
                canvas.scale(-1.0f, 1.0f);
                canvas.translate(-this.b.getBounds().width(), brg.a);
            }
            this.b.draw(canvas);
            canvas.restore();
        }
        if (this.c != null) {
            ...
            if (b(this.c, getLayoutDirection())) {
                canvas.scale(-1.0f, 1.0f);
                canvas.translate(-this.e.width(), brg.a);
            }
            this.c.draw(canvas);
            canvas.restore();
        }
