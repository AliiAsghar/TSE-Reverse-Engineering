...
public abstract class AddUserToGroupRequest implements Parcelable, ajpe {
    public static final Parcelable.Creator<AddUserToGroupRequest> CREATOR = new ajog(0);
    ...
    public final void writeToParcel(Parcel parcel, int i) {
        ...
        d().ifPresent(new aidg(parcel, 17));
        abhi.g(parcel, e);
    }
}
