...
public final class InfoAndOptionsActivity extends iyx implements akkh, akkg, aklg {
    private izc G;
    private boolean I;
    private Context J;
    private eno L;
                    ...
                    try {
                        try {
                            ...
                            if (activity instanceof InfoAndOptionsActivity) {
                                ...
                                this.G = new izc((Object) infoAndOptionsActivity);
                                e.close();
                                return;
                            }
                            throw new IllegalStateException(hht.d(activity, izc.class, "Attempt to inject a Activity wrapper of type "));
    ...
    @Override // defpackage.iyk, defpackage.zgv, defpackage.zgu, defpackage.zgr, defpackage.zgw, defpackage.aitz, defpackage.cj, defpackage.re, defpackage.dx, android.app.Activity
    protected final void onCreate(Bundle bundle) {
        ...
        try {
            ...
            Object obj = J().a;
            Toolbar toolbar = ((zgv) obj).C;
            if (toolbar != null) {
                toolbar.setElevation(brg.a);
                ((zgv) obj).C.invalidate();
            }
            this.I = false;
            this.H.l();
            s.close();
    ...
    protected final cg z(iym iymVar) {
        izc J = J();
        aozy createBuilder = izg.a.createBuilder();
        if (!createBuilder.b.isMutable()) {
            createBuilder.u();
        }
        izg izgVar = (izg) createBuilder.b;
        iymVar.getClass();
        izgVar.c = iymVar;
        izgVar.b |= 1;
        String stringExtra = ((InfoAndOptionsActivity) J.a).getIntent().getStringExtra("rbm_bot_id");
        stringExtra.getClass();
        if (!createBuilder.b.isMutable()) {
            createBuilder.u();
        }
        ((izg) createBuilder.b).d = stringExtra;
        izg izgVar2 = (izg) createBuilder.s();
        izf izfVar = new izf();
        apxh.e(izfVar);
        aklt.a(izfVar, izgVar2);
        return izfVar;
    }
