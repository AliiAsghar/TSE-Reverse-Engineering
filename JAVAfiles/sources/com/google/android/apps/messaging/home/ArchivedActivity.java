...
public final class ArchivedActivity extends kuu implements akkh, akkg, aklg {
    private kup G;
    private boolean I;
    private Context J;
    private eno L;
                    ...
                    try {
                        try {
                            ...
                            if (activity instanceof ArchivedActivity) {
                                ...
                                apya apyaVar2 = ((kqj) aS).C;
                                krx krxVar = ((kqj) aS).b.a;
                                this.G = new kup(archivedActivity, aabrVar, apyaVar, apyaVar2, krxVar.dQ, krxVar.fM);
                                e.close();
                                this.G.d = this;
                                return;
                            }
                            throw new IllegalStateException(hht.d(activity, kup.class, "Attempt to inject a Activity wrapper of type "));
    ...
    public final void fa(en enVar) {
        super.fa(enVar);
        kup J = J();
        ArchivedActivity archivedActivity = J.a;
        Toolbar eZ = archivedActivity.eZ();
        aabr aabrVar = J.c;
        lga.O(archivedActivity, eZ, enVar, R.string.archived_activity_title);
    }
