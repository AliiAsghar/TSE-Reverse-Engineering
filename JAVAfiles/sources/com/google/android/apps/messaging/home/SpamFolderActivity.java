...
public final class SpamFolderActivity extends kuv implements akkh, akkg, aklg {
    private kwh G;
    private boolean I;
    private Context J;
    private eno L;
                    ...
                    try {
                        try {
                            ...
                            if (activity instanceof SpamFolderActivity) {
                                ...
                                aabr aabrVar = (aabr) ((kqj) aS).i.b();
                                via viaVar = (via) ((kqj) aS).b.mt.b();
                                zai zaiVar = (zai) ((kqj) aS).b.rO.b();
                                apya apyaVar = ((kqj) aS).B;
                                krv krvVar = ((kqj) aS).b;
                                apya apyaVar2 = krvVar.AV;
                                apya apyaVar3 = ((kqj) aS).C;
                                apya apyaVar4 = ((kqj) aS).F;
                                Optional of = Optional.of(krvVar.a.fK);
                                krx krxVar = ((kqj) aS).b.a;
                                this.G = new kwh(spamFolderActivity, aabrVar, viaVar, zaiVar, apyaVar, apyaVar2, apyaVar3, apyaVar4, of, krxVar.dQ, krxVar.fM);
                                e.close();
                                this.G.f = this;
                                return;
                            }
                            throw new IllegalStateException(hht.d(activity, kwh.class, "Attempt to inject a Activity wrapper of type "));
    ...
    public final void fa(en enVar) {
        super.fa(enVar);
        kwh J = J();
        SpamFolderActivity spamFolderActivity = J.a;
        Toolbar eZ = spamFolderActivity.eZ();
        aabr aabrVar = J.e;
        lga.O(spamFolderActivity, eZ, enVar, R.string.spam_folder_activity_title);
    }
    ...
    public final void h(cg cgVar) {
        super.h(cgVar);
        boolean z = cgVar instanceof kux;
        kwh J = J();
        if (z) {
            ((kux) cgVar).E().aG = J;
        }
    ...
    public final void onCreate(Bundle bundle) {
        ...
        try {
            ...
            J.a.setContentView(R.layout.home_activity_with_fragment_container);
            Intent intent = J.a.getIntent();
            if (intent != null) {
                int R = a.R(intent.getIntExtra("spam_folder_opened_source", 0));
                zai zaiVar = J.d;
                if (R != 0) {
                    qiu.h(aktp.ah(new ebm(zaiVar, R, 12), zaiVar.c));
                } else {
                    throw null;
                }
            }
