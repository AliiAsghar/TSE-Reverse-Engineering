...
public final class AdvancedFeedbackActivity extends ktu implements akkh, akkg, aklg {
    private kth G;
    private boolean I;
    private Context J;
    private eno L;
                    ...
                    try {
                        try {
                            ...
                            if (activity instanceof AdvancedFeedbackActivity) {
                                ...
                                this.G = new kth(advancedFeedbackActivity);
                                e.close();
                                this.G.e = this;
                                return;
                            }
                            throw new IllegalStateException(hht.d(activity, kth.class, "Attempt to inject a Activity wrapper of type "));
    ...
    public final void onCreate(Bundle bundle) {
        ...
        try {
            ...
            kth J = J();
            J.a.setContentView(R.layout.advanced_feedback_activity);
            Bundle extras = J.a.getIntent().getExtras();
            J.b = null;
            ...
            if (bundle == null) {
                ...
                bdVar.q(R.id.advanced_feedback_fragment_container, a);
                bdVar.y();
                bdVar.b();
            } else {
                J.d = a.ac()[bundle.getInt("current_ui_state")];
            }
            J.c = new ktg(J);
            J.a.c().b(J.a, J.c);
            aktp.bG(this).a = findViewById(android.R.id.content);
            kth kthVar = this.G;
            aktp.F(this, ktt.class, new ixl(kthVar, 17));
            aktp.F(this, kts.class, new ixl(kthVar, 18));
            aktp.F(this, kub.class, new ixl(kthVar, 19));
            this.I = false;
            this.H.l();
            s.close();
        } catch (Throwable th) {
