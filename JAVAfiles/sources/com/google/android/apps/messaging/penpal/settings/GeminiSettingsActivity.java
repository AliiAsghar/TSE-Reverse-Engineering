...
public final class GeminiSettingsActivity extends lqr implements akkh, akkg, aklg {
    private lqn G;
    private boolean I;
    private Context J;
    private eno L;
                    ...
                    try {
                        try {
                            ...
                            if (activity instanceof GeminiSettingsActivity) {
                                ...
                                this.G = new lqn(geminiSettingsActivity);
                                e.close();
                                return;
                            }
                            throw new IllegalStateException(hht.d(activity, lqn.class, "Attempt to inject a Activity wrapper of type "));
    ...
    public final void onCreate(Bundle bundle) {
        ...
        try {
            ...
            Object obj = J.a;
            ((lzf) obj).setTitle(((GeminiSettingsActivity) obj).getString(R.string.gemini_settings_page_title));
            lqo lqoVar = new lqo();
            apxh.e(lqoVar);
            bdVar.z(R.id.fragment_container, lqoVar);
            bdVar.b();
            this.I = false;
            this.H.l();
            s.close();
