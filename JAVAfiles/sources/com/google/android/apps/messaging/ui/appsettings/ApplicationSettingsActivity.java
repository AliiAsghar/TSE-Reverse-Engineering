...
public final class ApplicationSettingsActivity extends zim implements akkh, akkg, aklg {
    private zhi G;
    private boolean I;
    private Context J;
    private eno L;
                    ...
                    try {
                        try {
                            ...
                            if (activity instanceof ApplicationSettingsActivity) {
                                ...
                                mbl mblVar = (mbl) ((kqj) aS).b.bB.b();
                                apya apyaVar = ((kqj) aS).B;
                                krv krvVar = ((kqj) aS).b;
                                this.G = new zhi(applicationSettingsActivity, mblVar, apyaVar, krvVar.AV, ((kqj) aS).C, Optional.of((iba) krvVar.a.fK.b()));
                                e.close();
                                return;
                            }
                            throw new IllegalStateException(hht.d(activity, zhi.class, "Attempt to inject a Activity wrapper of type "));
    ...
    /* JADX WARN: Type inference failed for: r6v3, types: [mbl, java.lang.Object] */
    ...
    public final void onCreate(Bundle bundle) {
        ...
        try {
            ...
            zhi J = J();
            en j = ((lzf) J.b).j();
            if (j != null && ((ApplicationSettingsActivity) J.b).getIntent().getBooleanExtra("top_level_settings", false)) {
                yzc.p((Context) J.b, j, R.string.settings_activity_title);
            }
            J.a.c("Bugle.UI.Settings.Application");
            this.I = false;
            this.H.l();
            s.close();
        } catch (Throwable th) {
