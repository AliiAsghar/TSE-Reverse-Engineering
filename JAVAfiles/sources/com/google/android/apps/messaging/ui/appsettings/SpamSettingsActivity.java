...
public final class SpamSettingsActivity extends zjc implements akkh, akkg, aklg {
    private zml G;
    private boolean I;
    private Context J;
    private eno L;
                    ...
                    try {
                        try {
                            ...
                            if (activity instanceof SpamSettingsActivity) {
                                ...
                                this.G = new zml(spamSettingsActivity, (lzv) ((kqj) aS).b.yJ.b(), (ksm) ((kqj) aS).b.a.fP.b(), (mho) ((kqj) aS).b.gD.b());
                                e.close();
                                return;
                            }
                            throw new IllegalStateException(hht.d(activity, zml.class, "Attempt to inject a Activity wrapper of type "));
    ...
    public final void onCreate(Bundle bundle) {
        ...
        try {
            ...
            zml J = J();
            J.c.getWindow().setStatusBarColor(0);
            TextView textView = (TextView) J.c.findViewById(R.id.spam_preference_fragment_container_text_view);
            textView.setOnClickListener(new uai(J, 16));
            SpannableStringBuilder ad = aabr.ad(J.c, R.string.spam_protection_consent_string);
            textView.setText(ad);
            textView.setContentDescription(ad.toString());
            bd bdVar = new bd(J.c.a());
            zmm zmmVar = new zmm();
            apxh.e(zmmVar);
            bdVar.z(R.id.spam_preference_fragment_container, zmmVar);
            bdVar.i();
            this.I = false;
            this.H.l();
            s.close();
    ...
    protected final int z() {
        J();
        return R.layout.spam_settings_activity_gm3;
    }
