...
public final class TurnOffRcsActivity extends zjg implements akkh, akkg, aklg {
    private zng G;
    private boolean I;
    private Context J;
    private eno L;
                    ...
                    try {
                        try {
                            ...
                            if (activity instanceof TurnOffRcsActivity) {
                                ...
                                this.G = new zng(turnOffRcsActivity);
                                e.close();
                                return;
                            }
                            throw new IllegalStateException(hht.d(activity, zng.class, "Attempt to inject a Activity wrapper of type "));
    ...
    public final void onCreate(Bundle bundle) {
        ...
        try {
            ...
            znh znhVar = new znh();
            apxh.e(znhVar);
            bd bdVar = new bd(((zgv) zngVar.a).a());
            bdVar.q(R.id.content, znhVar);
            bdVar.b();
            this.I = false;
            this.H.l();
            s.close();
