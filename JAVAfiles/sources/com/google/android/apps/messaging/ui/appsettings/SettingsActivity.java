...
public final class SettingsActivity extends ziv implements akkh, akkg, aklg {
    private zlg C;
    private boolean E;
    private Context F;
    private eno H;
                    ...
                    try {
                        try {
                            ...
                            if (activity instanceof SettingsActivity) {
                                ...
                                lzv lzvVar = (lzv) ((kqj) aS).b.yJ.b();
                                yjy yjyVar = (yjy) ((kqj) aS).b.aF.b();
                                apya apyaVar = ((kqj) aS).B;
                                krv krvVar = ((kqj) aS).b;
                                this.C = new zlg(settingsActivity, lzvVar, yjyVar, apyaVar, krvVar.AV, ((kqj) aS).C, Optional.of((iba) krvVar.a.fK.b()));
                                e.close();
                                this.C.d = this;
                                return;
                            }
                            throw new IllegalStateException(hht.d(activity, zlg.class, "Attempt to inject a Activity wrapper of type "));
