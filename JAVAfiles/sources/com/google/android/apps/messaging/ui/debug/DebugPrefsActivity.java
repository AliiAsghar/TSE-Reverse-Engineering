...
public final class DebugPrefsActivity extends aamj implements akkh, akkg, aklg {
    private aajt n;
    private boolean p;
    private Context q;
    private eno s;
                    ...
                    try {
                        try {
                            ...
                            if (activity instanceof DebugPrefsActivity) {
                                ...
                                this.n = new aajt(debugPrefsActivity);
                                e.close();
                                return;
                            }
                            throw new IllegalStateException(hht.d(activity, aajt.class, "Attempt to inject a Activity wrapper of type "));
    ...
    public final void onCreate(Bundle bundle) {
        ...
        try {
            ...
            D();
            Object obj = this.n.a;
            ((zgr) obj).setContentView(R.layout.debug_prefs_activity);
            ((DebugPrefsActivity) obj).setTitle("Bugle Prefs");
            this.p = false;
            this.o.l();
            s.close();
        } catch (Throwable th) {
