...
public final class RichCardsSettingsActivity extends ziu implements akkh, akkg, aklg {
    private zlc G;
    private boolean I;
    private Context J;
    private eno L;
            ...
            if (this.I) {
                ...
                try {
                    ...
                    try {
                        try {
                            Object aS = aS();
                            this.G = new zlc(((kqj) aS).l(), (lzv) ((kqj) aS).b.yJ.b(), ((kqj) aS).l(), ((kqj) aS).B, ((kqj) aS).C);
                            e.close();
                            return;
    ...
    public final void onCreate(Bundle bundle) {
        ...
        try {
            ...
            zlc J = J();
            ((RichCardsSettingsActivity) J.c).getWindow().setStatusBarColor(0);
            TextView textView = (TextView) ((lzf) J.c).findViewById(R.id.rich_cards_preference_info_text_id);
            textView.setOnClickListener(new uai(J, 15));
            SpannableStringBuilder ad = aabr.ad((Context) J.c, R.string.new_rich_cards_preference_info_text);
            textView.setText(ad);
