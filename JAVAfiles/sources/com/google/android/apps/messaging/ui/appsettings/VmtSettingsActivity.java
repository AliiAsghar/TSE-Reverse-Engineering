...
public final class VmtSettingsActivity extends zjj implements akkh, akkg, aklg {
    private znp G;
    private boolean I;
    private Context J;
    private eno L;
                    ...
                    try {
                        try {
                            ...
                            if (activity instanceof VmtSettingsActivity) {
                                ...
                                this.G = new znp(vmtSettingsActivity, Optional.empty());
                                e.close();
                                return;
                            }
                            throw new IllegalStateException(hht.d(activity, znp.class, "Attempt to inject a Activity wrapper of type "));
    ...
    public final void onCreate(Bundle bundle) {
        ...
        try {
            ...
            znp J = J();
            ((Optional) J.b).ifPresent(new zmi(new ynn(J, 13), 11));
            this.I = false;
            this.H.l();
            s.close();
        } catch (Throwable th) {
