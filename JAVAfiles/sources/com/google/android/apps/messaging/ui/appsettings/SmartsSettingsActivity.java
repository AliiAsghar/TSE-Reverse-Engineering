...
public final class SmartsSettingsActivity extends zja implements akkh, akkg, aklg {
    private zme G;
    private boolean I;
    private Context J;
    private eno L;
                    ...
                    try {
                        try {
                            ...
                            if (activity instanceof SmartsSettingsActivity) {
                                ...
                                this.G = new zme(smartsSettingsActivity, (lzv) ((kqj) aS).b.yJ.b(), ((kqj) aS).B, ((kqj) aS).b.AV, ((kqj) aS).C);
                                e.close();
                                return;
                            }
                            throw new IllegalStateException(hht.d(activity, zme.class, "Attempt to inject a Activity wrapper of type "));
    ...
    public final void onCreate(Bundle bundle) {
        ...
        try {
            ...
            if (!kpt.a() || !yig.b()) {
                ...
                zmf zmfVar = new zmf();
                apxh.e(zmfVar);
                bdVar.z(R.id.fragment_container, zmfVar);
                bdVar.i();
            }
            this.I = false;
            this.H.l();
    ...
    public final boolean onCreateOptionsMenu(Menu menu) {
        ...
        zme J = J();
        ((lzf) J.a).getMenuInflater().inflate(R.menu.smarts_settings_fragment_menu, menu);
        MenuItem findItem = menu.findItem(R.id.action_learn_more);
        findItem.setVisible(true);
        findItem.setOnMenuItemClickListener(new pf(J, 2));
        return true;
    }
