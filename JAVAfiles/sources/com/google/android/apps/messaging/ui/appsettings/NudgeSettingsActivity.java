...
public final class NudgeSettingsActivity extends zip implements akkh, akkg, aklg {
    private zjm G;
    private boolean I;
    private Context J;
    private eno L;
                    ...
                    try {
                        try {
                            ...
                            if (activity instanceof NudgeSettingsActivity) {
                                ...
                                this.G = new zjm(nudgeSettingsActivity);
                                e.close();
                                return;
                            }
                            throw new IllegalStateException(hht.d(activity, zjm.class, "Attempt to inject a Activity wrapper of type "));
    ...
    public final void onCreate(Bundle bundle) {
        ...
        try {
            ...
            zjn zjnVar = new zjn();
            apxh.e(zjnVar);
            bdVar.z(R.id.fragment_container, zjnVar);
            bdVar.i();
            this.I = false;
            this.H.l();
            s.close();
