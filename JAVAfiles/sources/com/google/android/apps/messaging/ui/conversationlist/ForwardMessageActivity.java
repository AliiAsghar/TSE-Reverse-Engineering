...
public final class ForwardMessageActivity extends aaic implements akkh, akkg, aklg {
    private aaib n;
    private boolean p;
    private Context q;
    private eno s;
                    ...
                    try {
                        try {
                            ...
                            if (activity instanceof ForwardMessageActivity) {
                                ...
                                krv krvVar = ((kqj) aS).b;
                                this.n = new aaib(forwardMessageActivity, krvVar.si, krvVar.yF, krvVar.a.cQ);
                                e.close();
                                return;
                            }
                            throw new IllegalStateException(hht.d(activity, aaib.class, "Attempt to inject a Activity wrapper of type "));
    ...
    public final void onCreate(Bundle bundle) {
        ...
        try {
            ...
            aaib D = D();
            aaik aP = aaik.aP();
            int intExtra = D.a.getIntent().getIntExtra("intent_source", 0);
            Bundle bundle2 = new Bundle(1);
            bundle2.putInt("intent_source", intExtra);
            aP.ak(bundle2);
            aP.q(D.a.a(), "ShareIntentFragment");
            D.c = (MessageCoreData) D.a.getIntent().getParcelableExtra("draft_data");
            if (qrl.a()) {
                D.d = (IncomingDraft) D.a.getIntent().getParcelableExtra("incoming_draft");
            }
            if (((ohi) D.b.b()).a()) {
                D.e = D.a.getIntent().getBooleanExtra("via_home_activity", false);
            }
            this.p = false;
            this.o.l();
            s.close();
