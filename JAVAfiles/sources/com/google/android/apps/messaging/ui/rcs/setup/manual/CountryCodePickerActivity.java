...
public final class CountryCodePickerActivity extends aazo implements akkh, akkg, aklg {
    private aazm G;
    private boolean I;
    private Context J;
    private eno L;
                    ...
                    try {
                        try {
                            ...
                            if (activity instanceof CountryCodePickerActivity) {
                                ...
                                krv krvVar = ((kqj) aS).b;
                                this.G = new aazm(countryCodePickerActivity, krvVar.gD, ((kqj) aS).ay, krvVar.a.fM);
                                e.close();
                                return;
                            }
                            throw new IllegalStateException(hht.d(activity, aazm.class, "Attempt to inject a Activity wrapper of type "));
    ...
    public final void h(cg cgVar) {
        super.h(cgVar);
        boolean z = cgVar instanceof ajca;
        aazm J = J();
        if (z) {
            ((ajca) cgVar).ah = J;
        }
    ...
    public final void onCreate(Bundle bundle) {
        ...
        try {
            ...
            aazm J = J();
            ((zgv) J.a).setContentView(R.layout.activity_country_code_picker);
            en j = ((zgv) J.a).j();
            if (j != null) {
                j.setDisplayHomeAsUpEnabled(true);
                j.setTitle(((CountryCodePickerActivity) J.a).getString(R.string.country_code_picker_title));
            }
            Toolbar eZ = ((zgv) J.a).eZ();
            if (eZ != null) {
                eZ.s(new aaxc(J, 19));
            }
            if (bundle == null) {
                String str = "";
                try {
                    byte[] byteArrayExtra = ((CountryCodePickerActivity) J.a).getIntent().getByteArrayExtra("com.google.android.apps.messaging.ui.rcs.setup.manual.extra.COUNTRY_CODE_SELECTED");
                    if (byteArrayExtra != null) {
                        J.e = (ajcb) apag.parseFrom(ajcb.a, byteArrayExtra);
                        str = ((ajcb) J.e).c;
                    }
                    bd bdVar = new bd(((zgv) J.a).a());
                    ...
                    ajcaVar.ak(bundle2);
                    bdVar.z(R.id.fragment_container, ajcaVar);
                    bdVar.i();
                } catch (apba e) {
