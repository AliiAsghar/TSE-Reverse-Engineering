...
public final class ConversationDetailsActivity extends zya implements akkh, akkg, aklg {
    private zxv G;
    private Context I;
    private eno K;
    private boolean L;
    ...
    public final void onCreate(Bundle bundle) {
        ...
        try {
                    ...
                    try {
                        try {
                            ...
                            if (activity instanceof ConversationDetailsActivity) {
                                ...
                                this.G = new zxv(conversationDetailsActivity, ((kqj) aS).aq, ((kqj) aS).ar, (ajxd) ((kqj) aS).B.b(), (akag) ((kqj) aS).b.AV.b());
                                e.close();
                            } else {
                                throw new IllegalStateException(hht.d(activity, zxv.class, "Attempt to inject a Activity wrapper of type "));
                            }
            ...
            zxv zxvVar = this.G;
            aktp.F(this, lln.class, new kwf(zxvVar, 15));
            aktp.F(this, llh.class, new kwf(zxvVar, 16));
            aktp.F(this, lnw.class, new kwf(zxvVar, 17));
            aktp.F(this, lnx.class, new kwf(zxvVar, 18));
            this.H.l();
            s.close();
        } catch (Throwable th2) {
            try {
