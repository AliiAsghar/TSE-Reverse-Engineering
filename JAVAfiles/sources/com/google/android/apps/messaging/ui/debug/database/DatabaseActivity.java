...
public final class DatabaseActivity extends aaoe implements akkh, akkg, aklg {
    private aant n;
    private boolean p;
    private Context q;
    private eno s;
                    ...
                    try {
                        try {
                            ...
                            if (activity instanceof DatabaseActivity) {
                                ...
                                this.n = new aant(databaseActivity);
                                e.close();
                                return;
                            }
                            throw new IllegalStateException(hht.d(activity, aant.class, "Attempt to inject a Activity wrapper of type "));
    ...
    public final void onCreate(Bundle bundle) {
        ...
        try {
            ...
            aant aantVar = this.n;
            if (bundle == null) {
                bd bdVar = new bd(((zgr) aantVar.a).a());
                aanx aanxVar = new aanx();
                apxh.e(aanxVar);
                bdVar.q(R.id.content, aanxVar);
                bdVar.b();
            }
            this.p = false;
            this.o.l();
