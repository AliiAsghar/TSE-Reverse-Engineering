...
public final class PerSubscriptionSettingsActivity extends zir implements akkh, akkg, aklg {
    private zjq G;
    private boolean I;
    private Context J;
    private eno L;
                    ...
                    try {
                        try {
                            ...
                            if (activity instanceof PerSubscriptionSettingsActivity) {
                                ...
                                this.G = new zjq(perSubscriptionSettingsActivity, (mbl) ((kqj) aS).b.bB.b(), ((kqj) aS).B, ((kqj) aS).b.AV, ((kqj) aS).C);
                                e.close();
                                return;
                            }
                            throw new IllegalStateException(hht.d(activity, zjq.class, "Attempt to inject a Activity wrapper of type "));
    ...
    /* JADX WARN: Type inference failed for: r5v3, types: [mbl, java.lang.Object] */
    ...
    public final void onCreate(Bundle bundle) {
        ...
        try {
            ...
            en j = ((lzf) J.b).j();
            if (j != null) {
                String stringExtra = ((PerSubscriptionSettingsActivity) J.b).getIntent().getStringExtra("per_sub_setting_title");
