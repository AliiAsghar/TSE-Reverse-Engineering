...
public final class SmartActionSettingsActivity extends zfd implements akkh, akkg, aklg {
    private zfh G;
    private boolean I;
    private Context J;
    private eno L;
                    ...
                    try {
                        try {
                            ...
                            if (activity instanceof SmartActionSettingsActivity) {
                                ...
                                this.G = new zfh(smartActionSettingsActivity);
                                e.close();
                                return;
                            }
                            throw new IllegalStateException(hht.d(activity, zfh.class, "Attempt to inject a Activity wrapper of type "));
    ...
    public final void onCreate(Bundle bundle) {
        ...
        try {
            ...
            zfi zfiVar = new zfi();
            apxh.e(zfiVar);
            bdVar.z(R.id.fragment_container, zfiVar);
            bdVar.b();
            this.I = false;
            this.H.l();
            s.close();
