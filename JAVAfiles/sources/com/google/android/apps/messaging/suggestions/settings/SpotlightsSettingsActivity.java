...
public final class SpotlightsSettingsActivity extends zff implements akkh, akkg, aklg {
    private zfm G;
    private boolean I;
    private Context J;
    private eno L;
                ...
                try {
                    ...
                    try {
                        try {
                            ...
                            if (activity instanceof SpotlightsSettingsActivity) {
                                SpotlightsSettingsActivity spotlightsSettingsActivity = (SpotlightsSettingsActivity) activity;
                                spotlightsSettingsActivity.getClass();
                                this.G = new zfm((Object) spotlightsSettingsActivity);
                                e.close();
                                return;
                            }
                            throw new IllegalStateException(hht.d(activity, zfm.class, "Attempt to inject a Activity wrapper of type "));
    ...
    public final void onCreate(Bundle bundle) {
        ...
        try {
            ...
            zfn zfnVar = new zfn();
            apxh.e(zfnVar);
            bdVar.z(R.id.fragment_container, zfnVar);
            bdVar.b();
            this.I = false;
            this.H.l();
            s.close();
