...
public final class MessageDetailsActivity extends lfi implements akkh, akkg, aklg {
    private lfj G;
    private boolean I;
    private Context J;
    private eno L;
                    ...
                    try {
                        try {
                            ...
                            if (activity instanceof MessageDetailsActivity) {
                                ...
                                this.G = new lfj(messageDetailsActivity, (ajxd) ((kqj) aS).B.b(), (akag) ((kqj) aS).b.AV.b());
                                e.close();
                                return;
                            }
                            throw new IllegalStateException(hht.d(activity, lfj.class, "Attempt to inject a Activity wrapper of type "));
    ...
    public final void onCreate(Bundle bundle) {
        ...
        try {
            ...
            aktp.F(this, llh.class, new kwf(this.G, 8));
            this.I = false;
            this.H.l();
            s.close();
        } catch (Throwable th) {
