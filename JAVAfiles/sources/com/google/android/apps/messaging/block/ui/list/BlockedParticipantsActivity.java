...
public final class BlockedParticipantsActivity extends iey implements akkh, akkg, aklg {
    private iew C;
    private boolean E;
    private Context F;
    private eno H;
    ...
    public final void onCreate(Bundle bundle) {
        ...
        try {
            ...
            iez iezVar = new iez();
            apxh.e(iezVar);
            bd bdVar = new bd(((BlockedParticipantsActivity) I.a.b()).a());
            bdVar.q(R.id.content, iezVar);
            bdVar.b();
            en j = ((BlockedParticipantsActivity) I.a.b()).j();
            if (j != null) {
                j.setDisplayHomeAsUpEnabled(true);
                j.setTitle(com.google.android.apps.messaging.R.string.blocked_destination_list_title);
            }
            this.E = false;
            this.D.l();
            s.close();
    ...
    public final boolean onOptionsItemSelected(MenuItem menuItem) {
        ...
        try {
            ...
            if (menuItem.getItemId() != 16908332) {
                ...
                ((BlockedParticipantsActivity) I.a.b()).c().d();
                z = true;
            }
            v.close();
            return z;
