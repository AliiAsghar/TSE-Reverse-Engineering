...
public final class NotificationSettingsActivity extends lpe implements akkh, akkg, aklg {
    private lpg G;
    private boolean I;
    private Context J;
    private eno L;
                    ...
                    try {
                        try {
                            ...
                            if (activity instanceof NotificationSettingsActivity) {
                                ...
                                this.G = new lpg((Object) notificationSettingsActivity);
                                e.close();
                                return;
                            }
                            throw new IllegalStateException(hht.d(activity, lpg.class, "Attempt to inject a Activity wrapper of type "));
    ...
    public final void onCreate(Bundle bundle) {
        ...
        try {
            ...
            lpg J = J();
            ((NotificationSettingsActivity) J.a).getWindow().setStatusBarColor(0);
            bd bdVar = new bd(((lzf) J.a).a());
            lph lphVar = new lph();
            apxh.e(lphVar);
            bdVar.z(R.id.notification_preference_fragment_container, lphVar);
            bdVar.b();
            this.I = false;
            this.H.l();
            s.close();
