...
public final class LoggingConsentSettingsActivity extends ibd implements akkh, akkg, aklg {
    private ibi G;
    private boolean I;
    private Context J;
    private eno L;
                    ...
                    try {
                        try {
                            ...
                            if (activity instanceof LoggingConsentSettingsActivity) {
                                ...
                                this.G = new ibi(loggingConsentSettingsActivity);
                                e.close();
                                return;
                            }
                            throw new IllegalStateException(hht.d(activity, ibi.class, "Attempt to inject a Activity wrapper of type "));
    ...
    public final void onCreate(Bundle bundle) {
        ...
        try {
            ...
            ibj ibjVar = new ibj();
            apxh.e(ibjVar);
            bdVar.z(R.id.logging_consent_preference_fragment_container, ibjVar);
            bdVar.b();
            this.I = false;
            this.H.l();
            s.close();
