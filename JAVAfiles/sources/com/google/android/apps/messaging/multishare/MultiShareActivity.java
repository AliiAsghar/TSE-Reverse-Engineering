...
public final class MultiShareActivity extends lfs implements akkh, akkg, aklg {
    private lft G;
    private boolean I;
    private Context J;
    private eno L;
                    ...
                    try {
                        try {
                            ...
                            if (activity instanceof MultiShareActivity) {
                                ...
                                this.G = new lft(multiShareActivity, ((kqj) aS).B, ((kqj) aS).C, ((kqj) aS).D, ((kqj) aS).b.a.fM);
                                e.close();
                                this.G.d = this;
                                return;
                            }
                            throw new IllegalStateException(hht.d(activity, lft.class, "Attempt to inject a Activity wrapper of type "));
    ...
    public final void onCreate(Bundle bundle) {
        ...
        try {
            ...
            aktp.F(this, llh.class, new kwf(this.G, 9));
            this.I = false;
            this.H.l();
            s.close();
        } catch (Throwable th) {
