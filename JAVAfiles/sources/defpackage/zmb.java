...
public final class zmb extends znf implements akkh, apxq, akkf, aklk, akrw {
    private zmc aj;
    private Context ak;
    ...
    @Override // defpackage.znf, defpackage.aiua, defpackage.cg
    ...
    public final void aN(Bundle bundle) {
        zmc E = E();
        aohs aohsVar = (aohs) E.d.b();
        wyp wypVar = (wyp) E.e.b();
        aohsVar.C(new akfk((ansy) wypVar.a, new ikn(wypVar, 15), "SIM_SELECTION_SETTINGS_DATASERVICE_KEY", 2), E.i);
        E.c.fR(R.xml.sim_selection_settings_preferences);
        E.j = E.c.d();
        E.j.ag();
        Context x = E.c.x();
        hwr.i(x);
        PreferenceScreen preferenceScreen = (PreferenceScreen) E.c.a(x.getString(R.string.general_settings_pref_key));
        hwr.i(preferenceScreen);
        Intent intent = new Intent(x, (Class<?>) ApplicationSettingsActivity.class);
        if ((E.c instanceof zmb) && kpt.a()) {
            ajwt ajwtVar = E.b;
            hwr.i(ajwtVar);
    ...
    @Override // defpackage.znf, defpackage.cg
            ...
            if (!this.ao) {
                ...
                if (this.aj == null) {
                    try {
                        ...
                        if (cgVar instanceof zmb) {
                            apya apyaVar = ((kql) aS).s;
                            apya apyaVar2 = ((kql) aS).ec;
                            krv krvVar = ((kql) aS).a;
                            this.aj = new zmc(ajwtVar, (zmb) cgVar, apyaVar, apyaVar2, krvVar.yJ, krvVar.pR, krvVar.dd);
                            this.Z.c(new akli(this.an, this.al));
                        } else {
                            throw new IllegalStateException(hht.e(cgVar, zmc.class));
                        }
