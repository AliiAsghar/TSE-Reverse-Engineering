...
public final class gsi {
    public static final gsi a = new hgi((char[]) null).j();
    public final Map b;

    public gsi(gsi gsiVar) {
        gsiVar.getClass();
        this.b = new HashMap(gsiVar.b);
    }

    /* JADX WARN: Multi-variable type inference failed */
    public static final gsi c(byte[] bArr) {
        boolean z;
        Object obj;
        bArr.getClass();
                                ...
                                for (int i2 = 0; i2 < readInt2; i2++) {
                                    ...
                                    if (readByte == 0) {
                                        ...
                                        for (int i9 = 0; i9 < readInt9; i9++) {
                                            ...
                                            if (true == d.F(readUTF2, "androidx.work.Data-95ed6082-b8e9-46e8-a73f-ff56f00f5d9d")) {
                                                readUTF2 = null;
                                            }
                                            strArr[i9] = readUTF2;
                                        }
                                        ...
                                        throw new IllegalStateException(a.bV(readByte, "Unsupported type "));
                                    }
                                    String readUTF3 = dataInputStream.readUTF();
                                    readUTF3.getClass();
                                    linkedHashMap.put(readUTF3, obj);
                                }
                                armd.i(dataInputStream, null);
                            } else {
                                throw new IllegalStateException(a.bV(readShort2, "Unsupported version number: "));
                            }
                        } else {
                            throw new IllegalStateException(a.bV(readShort, "Magic number doesn't match: "));
                        }
                    } catch (Throwable th3) {
                        try {
                            throw th3;
                        } catch (Throwable th4) {
                            armd.i(dataInputStream, th3);
                            throw th4;
                        }
                    }
                }
    ...
    */
    public final boolean equals(java.lang.Object r8) {
        ...
        L4:
            ...
            boolean r2 = defpackage.d.F(r2, r3)
            if (r2 != 0) goto L16
            goto L69
        L16:
            gsi r8 = (defpackage.gsi) r8
        ...
        L4c:
            ...
            boolean r3 = defpackage.aqil.b(r5, r3)
            goto L62
        L5e:
            boolean r3 = defpackage.d.F(r4, r3)
        L62:
            if (r3 != 0) goto L2f
            goto L67
        L65:
        ...
        L69:
            return r1
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.gsi.equals(java.lang.Object):boolean");
    }
    ...
    public final byte[] g(String str) {
        ...
        rh rhVar = new rh(obj, 20);
        byte[] bArr = new byte[length];
        for (int i = 0; i < length; i++) {
            bArr[i] = ((Number) rhVar.a(Integer.valueOf(i))).byteValue();
        }
        return bArr;
    }
    ...
    public final String toString() {
        return "Data {" + aqjn.aK(this.b.entrySet(), null, null, null, gvj.b, 31) + "}";
    }
