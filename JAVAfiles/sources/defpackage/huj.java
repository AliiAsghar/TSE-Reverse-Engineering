...
public final class huj extends FilterInputStream implements InputStreamRetargetInterface {
    ...
    public huj(InputStream inputStream, hqh hqhVar) {
        super(inputStream);
        this.d = -1;
        this.f = hqhVar;
        this.a = (byte[]) hqhVar.a(65536, byte[].class);
    }
    ...
    */
    private final int c(java.io.InputStream r6, byte[] r7) {
        ...
        L61:
            return r6
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.huj.c(java.io.InputStream, byte[]):int");
    }
    ...
    public final synchronized void reset() {
        if (this.a != null) {
            ...
            if (i != -1) {
                ...
                throw new hui("Mark has been invalidated, pos: " + this.e + " markLimit: " + this.c);
            }
        } else {
    ...
    */
    public final synchronized int read(byte[] r6, int r7, int r8) {
        ...
        L84:
            ...
            throw r6
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.huj.read(byte[], int, int):int");
    }
}
