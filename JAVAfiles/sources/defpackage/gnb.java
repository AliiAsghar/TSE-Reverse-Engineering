...
public final class gnb {
    ...
    public gnb(Parcel parcel) {
        this(parcel, parcel.dataPosition(), parcel.dataSize(), "", new vl(), new vl(), new vl());
    }
    ...
    public final gnc c() {
        ...
        try {
            ...
            if (method == null) {
                method = Class.forName(n, true, gnb.class.getClassLoader()).getDeclaredMethod("read", gnb.class);
                this.a.put(n, method);
            }
            return (gnc) method.invoke(null, m);
    ...
    public final void k(gnc gncVar) {
        if (gncVar != null) {
            try {
                r(v(gncVar.getClass()).getName());
                gnb m = m();
                try {
                    Class<?> cls = gncVar.getClass();
                    Method method = (Method) this.b.get(cls.getName());
                    if (method == null) {
                        method = v(cls).getDeclaredMethod("write", cls, gnb.class);
                        this.b.put(cls.getName(), method);
                    }
                    method.invoke(null, gncVar, m);
                    m.o();
                    return;
                } catch (ClassNotFoundException e) {
                    throw new RuntimeException(e);
                ...
                throw new RuntimeException(String.valueOf(gncVar.getClass().getSimpleName()).concat(" does not have a Parcelizer"), e5);
            }
        }
        r(null);
    }
    ...
    protected final gnb m() {
        ...
        String str = this.h;
        return new gnb(parcel, dataPosition, i2, str.concat("  "), this.a, this.b, this.c);
    }
    ...
    public final void u(gnc gncVar) {
        p(1);
        k(gncVar);
    }

    private gnb(Parcel parcel, int i, int i2, String str, vl vlVar, vl vlVar2, vl vlVar3) {
        this.a = vlVar;
        this.b = vlVar2;
        this.c = vlVar3;
