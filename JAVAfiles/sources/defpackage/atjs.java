...
public final class atjs implements atjp {
    ...
    private final InputStream c(String str) {
        ...
        InputStream inputStream = (InputStream) AccessController.doPrivileged(new atjr(this, concat, 0));
        if (inputStream == null) {
    ...
    */
    private final defpackage.atgc d(java.lang.String r6) {
        /*
            r5 = this;
            r0 = 0
            ...
            atgc r2 = defpackage.atow.n(r2, r6)     // Catch: java.lang.Throwable -> L28 java.io.IOException -> L2b
            goto L1a
        L11:
        ...
        L44:
            throw r6
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.atjs.d(java.lang.String):atgc");
    }
    ...
    public final atgc b(String str) {
        ...
        if (str != null && (obj = this.c.get(str)) != null) {
            if (obj instanceof SoftReference) {
                atgc atgcVar = (atgc) ((SoftReference) obj).get();
                if (atgcVar != null) {
                    return atgcVar;
                }
                return d(str);
    ...
    public atjs(byte[] bArr) {
        ...
        try {
            ...
            concurrentHashMap.put("UTC", new SoftReference(atgc.a));
