...
public final class aqis implements aojy {
    public final alog f;
    public final alpt g;
    private final alor j;
    public static final ahka a = new ahka("google.internal.communications.instantmessaging.v1.LighterCapabilities.");
    private static final ahka h = new ahka("google.internal.communications.instantmessaging.v1.LighterCapabilities/");
    public static final aojx b = new aqiq(3, (short[]) null);
    public static final aojx c = new aqiq(4, (int[]) null);
    public static final aojx d = new aqiq(5, (boolean[]) null);
    public static final aqis e = new aqis();
    private static final ahka i = new ahka("instantmessaging-pa.googleapis.com");
    ...
    private aqis() {
        ...
        aojx aojxVar2 = c;
        aojx aojxVar3 = d;
        alpt.s(aojxVar, aojxVar2, aojxVar3);
        alok alokVar = new alok();
        alokVar.h("RegisterCapabilities", aojxVar);
        alokVar.h("GetConversationProperties", aojxVar2);
        alokVar.h("GetUserCapabilities", aojxVar3);
        this.j = alokVar.b();
        new alok().b();
    }
    ...
    public final aojx b(String str) {
        ...
        if (str.startsWith(str2)) {
            ...
            if (this.j.containsKey(substring)) {
                return (aojx) this.j.get(substring);
            }
            return null;
        }
        return null;
