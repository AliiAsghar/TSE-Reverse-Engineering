...
public final class gvg extends gjk {
    ...
    public final void a(gkd gkdVar) {
        ...
        if (sharedPreferences.contains("reschedule_needed") || sharedPreferences.contains("last_cancel_all_time_ms")) {
            ...
            gkdVar.d();
            try {
                gkdVar.l(new Object[]{"last_cancel_all_time_ms", Long.valueOf(j2)});
                gkdVar.l(new Object[]{"reschedule_needed", Long.valueOf(j)});
        ...
        gkdVar.d();
        try {
            gkdVar.l(new Object[]{"next_job_scheduler_id", Integer.valueOf(i)});
            gkdVar.l(new Object[]{"next_alarm_manager_id", Integer.valueOf(i2)});
