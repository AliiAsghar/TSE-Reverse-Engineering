...
final class atpe extends atqr {
    private final atoq d;

    public atpe(atqn atqnVar, aslf aslfVar, atox atoxVar, atoq atoqVar) {
    ...
    public final Object a(atoo atooVar, Object[] objArr) {
        ...
        try {
            ...
            arvpVar.A();
            arvpVar.d(new arnd(atooVar2, 16));
            atooVar2.d(new atph(arvpVar, 1));
            Object l = arvpVar.l();
            if (l == arpl.a) {
                arpeVar.getClass();
            }
