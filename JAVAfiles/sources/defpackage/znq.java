...
public final class znq extends zjk implements akkh, apxq, akkf, aklk, akrw {
    private znr aj;
    private Context ak;
    ...
    @Override // defpackage.zjk, defpackage.aiua, defpackage.cg
    ...
    public final void aN(Bundle bundle) {
        znr E = E();
        E.c.ifPresent(new zmi(new ynn(E, 15), 12));
    }
    ...
    @Override // defpackage.zjk, defpackage.cg
            ...
            if (!this.ao) {
                ...
                if (this.aj == null) {
                    try {
                        ...
                        if (cgVar instanceof znq) {
                            this.aj = new znr((znq) cgVar, (akgu) ((kqm) aS).d.b(), Optional.empty(), (akvf) ((kqm) aS).R.b());
                            this.Z.c(new akli(this.an, this.al));
                        } else {
                            throw new IllegalStateException(hht.e(cgVar, znr.class));
                        }
    ...
    public final void g(Bundle bundle) {
        ...
        try {
            super.g(bundle);
            znr E = E();
            E.c.ifPresent(new zmi(new ynn(E, 14), 13));
            akqj.p();
        } catch (Throwable th) {
            try {
                akqj.p();
