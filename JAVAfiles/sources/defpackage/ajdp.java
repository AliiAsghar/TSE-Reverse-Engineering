...
public class ajdp<V extends View> extends ajds<V> {
    private Runnable a;
    OverScroller b;
    private boolean c;
    private int d;
    ...
    public int O(CoordinatorLayout coordinatorLayout, View view, int i, int i2, int i3) {
        throw null;
    }
    ...
    public final int V(CoordinatorLayout coordinatorLayout, View view, int i, int i2, int i3) {
        return O(coordinatorLayout, view, N() - i, i2, i3);
    }
    ...
    public final boolean d(CoordinatorLayout coordinatorLayout, View view, MotionEvent motionEvent) {
        ...
        if (motionEvent.getActionMasked() == 0) {
            ...
            if (S(view) && coordinatorLayout.k(view, x, y2)) {
                z = true;
            } else {
                z = false;
            }
    ...
    */
    public final boolean g(androidx.coordinatorlayout.widget.CoordinatorLayout r20, android.view.View r21, android.view.MotionEvent r22) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.ajdp.g(androidx.coordinatorlayout.widget.CoordinatorLayout, android.view.View, android.view.MotionEvent):boolean");
    }

    public ajdp(Context context, AttributeSet attributeSet) {
