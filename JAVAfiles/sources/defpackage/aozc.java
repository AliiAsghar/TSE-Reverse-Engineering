...
public final class aozc extends aozg {
    ...
    public aozc(byte[] bArr, int i, int i2) {
        this.f = bArr;
        this.g = i2 + i;
        this.i = i;
        this.j = i;
    ...
    public final String x() {
        ...
        if (j > 0) {
            ...
            int i2 = this.i;
            if (j <= i - i2) {
                String str = new String(this.f, i2, j, apay.a);
                this.i += j;
                return str;
            }
        }
