...
public abstract class hhr implements Closeable {
    ...
    public final hhq c(String str) {
        throw new hhq(str + " at path " + d());
    }
    ...
    public final void k(int i) {
        ...
        if (i2 == length) {
            if (i2 != 256) {
                ...
                throw new hhp("Nesting too deep at ".concat(d()));
            }
        }
        int[] iArr3 = this.c;
        int i3 = this.b;
    ...
    public abstract int q(ico icoVar);
}
