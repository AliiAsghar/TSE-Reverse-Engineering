...
public final class zfi extends zfe implements akkh, apxq, akkf, aklk, akrw {
    private zfj aj;
    private Context ak;
    ...
    @Override // defpackage.zfe, defpackage.aiua, defpackage.cg
    ...
    public final void aN(Bundle bundle) {
        zfi zfiVar = (zfi) E().a.b();
        zfiVar.b.f("bugle");
        zfiVar.fR(R.xml.smart_action_preferences);
        zfiVar.d().ag();
        SwatchieIllustrationPreference swatchieIllustrationPreference = (SwatchieIllustrationPreference) zfiVar.d().l(zfiVar.S(R.string.smart_actions_illustration_pref_key));
        if (swatchieIllustrationPreference != null) {
            swatchieIllustrationPreference.l(ajcm.a);
        }
    }
    ...
    @Override // defpackage.zfe, defpackage.cg
