...
public final class atiu implements atjg, atje {
    private final String a;
    private final String b;
    private final boolean c;
    private final int d;

    public atiu(String str, String str2, boolean z, int i) {
        this.a = str;
        this.b = str2;
        this.c = z;
        this.d = i;
    ...
    */
    public final int c(defpackage.atja r12, java.lang.CharSequence r13, int r14) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.atiu.c(atja, java.lang.CharSequence, int):int");
    }
    ...
    public final void d(Appendable appendable, long j, atfu atfuVar, int i, atgc atgcVar, Locale locale) {
        ...
        if (atgcVar != null) {
            ...
            int i7 = i4 / 60000;
            atjc.b(appendable, i7, 2);
            if (this.d != 2 && (i2 = i4 - (i7 * 60000)) != 0) {
                int i8 = i2 / 1000;
                if (this.c) {
                    appendable.append(':');
                }
                atjc.b(appendable, i8, 2);
                if (this.d != 3 && (i3 = i2 - (i8 * 1000)) != 0) {
                    if (this.c) {
                        appendable.append('.');
                    }
                    atjc.b(appendable, i3, 3);
                }
            }
        }
    }
