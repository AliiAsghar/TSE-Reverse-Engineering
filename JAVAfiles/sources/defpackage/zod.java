...
public final class zod extends zoa implements akkh, apxq, akkf, aklk, akrw {
    private zoe aj;
    private Context ak;
    ...
    @Override // defpackage.zoa, defpackage.aiua, defpackage.cg
    ...
    public final void aN(Bundle bundle) {
        zoe E = E();
        E.a.fR(R.xml.verified_sms_diagnostic_preferences);
        E.a.d().ag();
        zod zodVar = E.a;
        E.d = (SwitchPreferenceCompat) zodVar.d().l(zodVar.S(R.string.vsms_enabled_diagnostic_pref_key));
        SwitchPreferenceCompat switchPreferenceCompat = E.d;
        switchPreferenceCompat.getClass();
        switchPreferenceCompat.n = new zkp(E, 9);
        aohs aohsVar = E.g;
        yul yulVar = E.b;
        aohsVar.C(new akfk(yulVar.h, new ikn(yulVar, 10), "vsmssetting", 2), E.f);
    }
    ...
    @Override // defpackage.zoa, defpackage.cg
            ...
            if (!this.ao) {
                ...
                if (this.aj == null) {
                    try {
                        ...
                        if (cgVar instanceof zod) {
                            this.aj = new zoe((zod) cgVar, (aohs) ((kqm) aS).r.b(), (akbo) ((kqm) aS).o.b(), (yul) ((kqm) aS).a.oi.b());
                            this.Z.c(new akli(this.an, this.al));
                        } else {
                            throw new IllegalStateException(hht.e(cgVar, zoe.class));
                        }
