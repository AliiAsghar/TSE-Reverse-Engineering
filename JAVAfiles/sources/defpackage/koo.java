...
public final class koo extends kol implements akkh, apxq, akkf, aklk, akrw {
    private kor ah;
    private Context ai;
    ...
    public final View K(LayoutInflater layoutInflater, ViewGroup viewGroup, Bundle bundle) {
        ...
        try {
            ...
            Object obj = E().a;
            ((kot) obj).d = (TakeBugReportDialogView) layoutInflater.inflate(R.layout.diagnostics_dialog, (ViewGroup) null);
            TakeBugReportDialogView takeBugReportDialogView = ((kot) obj).d;
            this.al = false;
            akqj.p();
    ...
    @Override // defpackage.kol, defpackage.aiub, defpackage.cg
    ...
    @Override // defpackage.kol, defpackage.bw, defpackage.cg
            ...
            if (!this.am) {
                ...
                if (this.ah == null) {
                    try {
                        ...
                        if (cgVar instanceof koo) {
                            this.ah = new kor((koo) cgVar, new kot((ksm) ((kqm) aS).a.a.fP.b(), (mho) ((kqm) aS).a.gD.b()));
                            this.Z.c(new akli(this.ak, this.aj));
                        } else {
                            throw new IllegalStateException(hht.e(cgVar, kor.class));
                        }
    ...
    @Override // defpackage.kol, defpackage.cg
