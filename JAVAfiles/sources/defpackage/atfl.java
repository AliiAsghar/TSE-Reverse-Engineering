...
public final class atfl extends UrlResponseInfo {
    public final int a;
    ...
    public atfl(List list, int i, String str, List list2, String str2) {
        this.c = DesugarCollections.unmodifiableList(list);
        this.a = i;
        this.d = str;
        this.g = new atfk(DesugarCollections.unmodifiableList(list2));
        this.b = str2;
    }
    ...
    public final Map<String, List<String>> getAllHeaders() {
        atfk atfkVar = this.g;
        Map<String, List<String>> map = atfkVar.b;
        if (map == null) {
            TreeMap treeMap = new TreeMap(String.CASE_INSENSITIVE_ORDER);
            for (Map.Entry entry : atfkVar.a) {
            ...
            atfkVar.b = DesugarCollections.unmodifiableMap(treeMap);
            return atfkVar.b;
        }
        return map;
    }
