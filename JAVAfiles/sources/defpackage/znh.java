...
public final class znh extends zjh implements akkh, apxq, akkf, aklk, akrw {
    private znj a;
    private boolean ag;
    private Context d;
    ...
    public final View K(LayoutInflater layoutInflater, ViewGroup viewGroup, Bundle bundle) {
        ...
        try {
            ...
            composeView.setOnApplyWindowInsetsListener(new ivf(7));
            composeView.a(new cdj(-431242035, true, new zny(E, 1)));
            akqj.p();
            return composeView;
        } catch (Throwable th) {
            try {
    ...
    @Override // defpackage.zjh, defpackage.aiuc, defpackage.cg
    ...
    public final void aa() {
        ...
        try {
            aQ();
            Window window = ((cg) E().a).F().getWindow();
            if (window != null) {
                eea.c(window, true);
            }
            b.close();
    ...
    @Override // defpackage.zjh, defpackage.aklf, defpackage.cg
            ...
            if (!this.ag) {
                ...
                if (this.a == null) {
                    try {
                        ...
                        if (cgVar instanceof znh) {
                            this.a = new znj((znh) cgVar);
                            this.Z.c(new akli(this.c, this.e));
                        } else {
                            throw new IllegalStateException(hht.e(cgVar, znj.class));
                        }
    ...
    public final void g(Bundle bundle) {
        ...
        try {
            aP(bundle);
            eea.c(((cg) E().a).F().getWindow(), false);
            akqj.p();
        } catch (Throwable th) {
            try {
                akqj.p();
    ...
    @Override // defpackage.zjh, defpackage.cg
