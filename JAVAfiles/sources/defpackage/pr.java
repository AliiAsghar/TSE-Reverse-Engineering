...
public final class pr {
    ...
    public static int a(Context context, int i) {
        ...
        return eap.h(b(context, i), Math.round(Color.alpha(r4) * f2));
    }

    public static int b(Context context, int i) {
        int[] iArr = g;
        iArr[0] = i;
        ktk z = ktk.z(context, null, iArr);
        try {
            return z.w(0);
        } finally {
            z.t();
    ...
    public static void d(View view, Context context) {
        TypedArray obtainStyledAttributes = context.obtainStyledAttributes(gc.k);
        try {
