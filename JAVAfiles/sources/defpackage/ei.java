...
public final class ei implements Parcelable {
    public static final Parcelable.Creator<ei> CREATOR = new bf(11);
    final int a;
    final long b;
    final long c;
    final float d;
    ...
    public ei(Parcel parcel) {
        ...
        this.i = parcel.createTypedArrayList(eh.CREATOR);
        this.j = parcel.readLong();
        this.k = parcel.readBundle(ef.class.getClassLoader());
