...
public final class zhf extends zmy implements akkh, apxq, akkf, aklk, akrw {
    private zhg aj;
    private Context ak;
    ...
    @Override // defpackage.zmy, defpackage.aiua, defpackage.cg
    ...
    @Override // defpackage.zmy, defpackage.cg
            ...
            if (!this.ao) {
                ...
                if (this.aj == null) {
                    try {
                        ...
                        if (cgVar instanceof zhf) {
                            this.aj = new zhg((zhf) cgVar, ((kql) aS).dL);
                            this.Z.c(new akli(this.an, this.al));
                        } else {
                            throw new IllegalStateException(hht.e(cgVar, zhg.class));
                        }
