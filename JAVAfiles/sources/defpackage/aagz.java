...
public final class aagz extends aahj {
    private final Context e;

    public aagz(Context context, SuggestionData suggestionData, View view) {
    ...
    public final String c() {
        return this.e.getString(R.string.p2p_conversation_suggestion_share_location_text);
    }
}
