...
public class mh extends ListView {
    public boolean a;
    public bo b;
    ...
    */
    public final boolean a(android.view.MotionEvent r17, int r18) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.mh.a(android.view.MotionEvent, int):boolean");
    }
    ...
    public boolean onHoverEvent(MotionEvent motionEvent) {
        ...
        if (actionMasked == 10) {
            if (this.b == null) {
                bo boVar = new bo(this, 13, null);
                this.b = boVar;
                ((mh) boVar.a).post(boVar);
            }
            actionMasked = 10;
        }
    ...
    public final void setSelector(Drawable drawable) {
        mf mfVar;
        if (drawable != null) {
            mfVar = new mf(drawable);
        } else {
            mfVar = null;
        }
        this.i = mfVar;
        super.setSelector(mfVar);
        Rect rect = new Rect();
        if (drawable != null) {
