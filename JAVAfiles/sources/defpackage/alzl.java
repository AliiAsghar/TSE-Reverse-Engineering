...
public enum alzl {
    ...
    static {
        ...
        for (alzl alzlVar : values()) {
            if (hashMap.put(Character.valueOf(alzlVar.G), alzlVar) != null) {
                throw new IllegalStateException("duplicate format character: ".concat(String.valueOf(String.valueOf(alzlVar))));
            }
        }
