...
public final class anzd {
    ...
    public BigInteger a = anzg.e;
    public anze b = null;
    public anze c = null;
    private Integer h = null;
    public anzf d = anzf.d;
                            ...
                            if (this.h != null) {
                                if (num.intValue() >= 2048) {
                                    if (this.b == this.c) {
                                        ...
                                        int compareTo = bigInteger.compareTo(anzg.e);
                                        if (compareTo != 0) {
                                            if (compareTo >= 0) {
                                        ...
                                        return new anzg(this.g.intValue(), this.a, this.d, this.b, this.c, this.h.intValue());
                                    }
