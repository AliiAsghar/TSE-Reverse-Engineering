...
public class ajhx extends mu {
    ...
    public ajhx(Context context, AttributeSet attributeSet) {
        this(context, attributeSet, 0);
    }

    public ajhx(Context context, AttributeSet attributeSet, int i) {
        ...
        this.a = true;
        this.b = false;
        TypedArray a = ajig.a(context, attributeSet, ajhz.a, i, 0, new int[0]);
