...
public final class aqiu implements aojy {
    public final alog g;
    public final alpt h;
    private final alor k;
    public static final ahka a = new ahka("google.internal.communications.instantmessaging.v1.LighterFrontend.");
    private static final ahka i = new ahka("google.internal.communications.instantmessaging.v1.LighterFrontend/");
    public static final aojx b = new aqiq(15, (short[][][]) null);
    public static final aojx c = new aqiq(16, (int[][][]) null);
    public static final aojx d = new aqiq(17, (boolean[][][]) null);
    public static final aojx e = new aqiq(18, (float[][][]) null);
    public static final aqiu f = new aqiu();
    private static final ahka j = new ahka("instantmessaging-pa.googleapis.com");
    ...
    private aqiu() {
        ...
        aojx aojxVar3 = d;
        aojx aojxVar4 = e;
        alpt.t(aojxVar, aojxVar2, aojxVar3, aojxVar4);
        alok alokVar = new alok();
        alokVar.h("SendLighterMessage", aojxVar);
        alokVar.h("GetLighterProfile", aojxVar2);
        alokVar.h("BatchGetLighterProfile", aojxVar3);
        alokVar.h("GetOpenConversation", aojxVar4);
        this.k = alokVar.b();
        new alok().b();
    }
    ...
    public final aojx b(String str) {
        ...
        if (str.startsWith(str2)) {
            ...
            if (this.k.containsKey(substring)) {
                return (aojx) this.k.get(substring);
            }
            return null;
        }
        return null;
