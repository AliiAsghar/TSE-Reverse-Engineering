...
public final class atbk implements PrivateKey, Key {
    private static final long serialVersionUID = 1;
    private transient aswg a;
    private transient ASN1Set b;

    public atbk(PrivateKeyInfo privateKeyInfo) {
        a(privateKeyInfo);
    }

    private final void a(PrivateKeyInfo privateKeyInfo) {
        this.b = privateKeyInfo.b;
        this.a = (aswg) atow.au(privateKeyInfo);
    }
    ...
    public final boolean equals(Object obj) {
        ...
        if (obj instanceof atbk) {
            return Arrays.equals(this.a.a(), ((atbk) obj).a.a());
        }
        return false;
    }
