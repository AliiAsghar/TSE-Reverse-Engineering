...
public class alzu extends alzs {
    ...
    static {
        ...
        Le:
            java.lang.String r0 = "\n"
        L10:
            defpackage.alzu.a = r0
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.alzu.<clinit>():void");
    }
    ...
    public static int b(String str, int i) {
        while (i < str.length()) {
            ...
            if (str.charAt(i) != '%') {
                ...
                throw alzt.c("trailing unquoted '%' character", str, i);
            }
        }
        return -1;
    }
