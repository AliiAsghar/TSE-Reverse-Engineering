...
public final class eas {
    ...
    public static void a(Path path, float f, float f2, float f3, float f4, float f5, float f6, float f7, boolean z, boolean z2) {
        ...
        while (i < ceil) {
            ...
            double d43 = d30;
            double d44 = d38 + (d37 * sin5);
            double d45 = d29;
            double d46 = d6 + (d36 * sin5);
            double d47 = d27;
            path.rLineTo(brg.a, brg.a);
            double d48 = d29 + d30 + (d15 * sin2 * cos4) + (d35 * sin4);
            double d49 = atan22;
            double d50 = ((d27 - d28) + ((d15 * cos2) * cos4)) - (d33 * sin4);
            d36 = (sin4 * d40) + (cos4 * d35);
            double d51 = (d32 * sin4) - (d33 * cos4);
            path.cubicTo((float) d44, (float) d46, (float) (d50 - (sin5 * d51)), (float) (d48 - (sin5 * d36)), (float) d50, (float) d48);
            i++;
            d30 = d43;
            d29 = d45;
            ceil = ceil;
    ...
    public eas(eas easVar) {
        this.a = easVar.a;
        float[] fArr = easVar.b;
        this.b = dyw.e(fArr, fArr.length);
    }
}
