...
public final class aohv {
    ...
    private final aohx e = new aohx();

    public aohv(Context context, aohf aohfVar) {
        this.c = context;
        this.d = aohfVar;
    }

    static long a(String str) {
        d.t(a.matcher(str).matches(), "Invalid Expiration Timestamp.");
    ...
    */
    private final java.net.HttpURLConnection d(java.net.URL r9, java.lang.String r10) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.aohv.d(java.net.URL, java.lang.String):java.net.HttpURLConnection");
    }
    ...
    public final aohw b(String str, String str2, String str3, String str4, String str5) {
        String str6;
        ...
        if (this.e.b()) {
            ...
            for (?? r8 = 1; i <= r8; r8 = 1) {
                ...
                try {
                    ...
                    if (h(responseCode)) {
                        ...
                        jsonReader.close();
                        inputStream.close();
                        aohwVar = new aohw(str11, str12, str13, aohzVar, 1);
                    } else {
                        try {
                            str6 = str10;
                            f(d, str4, str, str3);
                        ...
                        if (responseCode != 429) {
                            if (responseCode < 500 || responseCode >= 600) {
                                e();
                                aohwVar = new aohw(null, null, null, null, 2);
                            } else {
                                d.disconnect();
                                TrafficStats.clearThreadStatsTag();
                                i++;
                            ...
                            throw new aohj("Firebase servers have received too many requests from this client in a short period of time. Please try again later.");
                        }
                    }
                    return aohwVar;
                } finally {
            ...
            throw new aohj("Firebase Installations Service is unavailable. Please try again later.");
        }
        throw new aohj("Firebase Installations Service is unavailable. Please try again later.");
    }

    public final aohz c(String str, String str2, String str3, String str4) {
        aohz a2;
        if (this.e.b()) {
            ...
            for (int i = 0; i <= 1; i++) {
                ...
                try {
                    try {
                        d.setRequestMethod("POST");
                        d.addRequestProperty("Authorization", a.cp(str4, "FIS_v2 "));
                        d.setDoOutput(true);
                    } catch (IOException | AssertionError unused) {
                    }
                    try {
