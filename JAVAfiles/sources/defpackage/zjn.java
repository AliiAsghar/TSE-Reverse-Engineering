...
public final class zjn extends ziq implements akkh, apxq, akkf, aklk, akrw {
    private zjp aj;
    private Context ak;
    ...
    @Override // defpackage.ziq, defpackage.aiua, defpackage.cg
    ...
    public final void aN(Bundle bundle) {
        zjp E = E();
        if (!((Optional) ((apxx) E.d).a).isEmpty()) {
            ((zjn) E.a.b()).b.f("bugle");
            ((zjn) E.a.b()).fR(R.xml.nudge_preferences);
            ((zjn) E.a.b()).d().ag();
            E.f = E.a(R.string.nudge_reply_enabled_pref_key);
            E.g = E.a(R.string.birthday_nudge_enabled_pref_key);
            if (!zjp.b()) {
                Optional optional = E.g;
                PreferenceScreen d = ((zjn) E.a.b()).d();
                d.getClass();
                optional.ifPresent(new zjo(d, 1));
                E.g = Optional.empty();
            }
            E.f.ifPresent(new zjo(E, 0));
            ((aohs) E.b.b()).D(((yiz) ((Optional) ((apxx) E.d).a).get()).a(), akgd.FEW_SECONDS, E.h);
            E.f.ifPresent(new zjo(E, 2));
            E.g.ifPresent(new zjo(E, 3));
            Optional a = E.a(R.string.nudge_learn_more_pref_key);
            if (!a.isEmpty()) {
                ((Preference) a.get()).o = new lpi(E, 7);
                Preference preference = (Preference) a.get();
                String S = ((zjn) E.a.b()).S(R.string.nudge_learn_more_info_text);
                preference.M(aabr.af(((zjn) E.a.b()).F(), S, S));
            }
        }
    }
    ...
    @Override // defpackage.ziq, defpackage.cg
        ...
        try {
            if (!this.ao) {
                ...
                if (this.aj == null) {
                    try {
                        Object aS = aS();
                        apya apyaVar = ((kqm) aS).X;
                        apya apyaVar2 = ((kqm) aS).r;
                        apya apyaVar3 = ((kqm) aS).o;
                        krv krvVar = ((kqm) aS).a;
                        this.aj = new zjp(apyaVar, apyaVar2, apyaVar3, krvVar.vr, krvVar.yJ);
