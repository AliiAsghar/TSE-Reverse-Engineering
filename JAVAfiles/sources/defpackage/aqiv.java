...
public final class aqiv implements aojy {
    public final alog e;
    public final alpt f;
    private final alor i;
    public static final ahka a = new ahka("google.internal.communications.instantmessaging.v1.LighterUserPropertiesService.");
    private static final ahka g = new ahka("google.internal.communications.instantmessaging.v1.LighterUserPropertiesService/");
    public static final aojx b = new aqiq(19, (byte[]) null, (byte[]) null);
    public static final aojx c = new aqiq(20, (char[]) null, (byte[]) null);
    public static final aqiv d = new aqiv();
    private static final ahka h = new ahka("instantmessaging-pa.googleapis.com");
    ...
    private aqiv() {
        ...
        aojx aojxVar = b;
        aojx aojxVar2 = c;
        alpt.r(aojxVar, aojxVar2);
        alok alokVar = new alok();
        alokVar.h("GetUserProperties", aojxVar);
        alokVar.h("SetUserProperties", aojxVar2);
        this.i = alokVar.b();
        new alok().b();
    }
    ...
    public final aojx b(String str) {
        ...
        if (str.startsWith(str2)) {
            ...
            if (this.i.containsKey(substring)) {
                return (aojx) this.i.get(substring);
            }
            return null;
        }
        return null;
