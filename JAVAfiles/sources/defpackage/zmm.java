...
public final class zmm extends zjd implements akkh, apxq, akkf, aklk, akrw {
    private zmn aj;
    private Context ak;
    ...
    @Override // defpackage.zjd, defpackage.aiua, defpackage.cg
    ...
    public final void aN(Bundle bundle) {
        zmn E = E();
        yyt yytVar = (yyt) E.b;
        boolean q = ((ykw) yytVar.d.b()).q(((Context) yytVar.b).getString(R.string.spam_detection_pref_key), false);
        atal X = ((wfh) yytVar.c.b()).X();
        if (!yytVar.i(X, q) && X.m() != q) {
            ((ykw) yytVar.d.b()).h(((Context) yytVar.b).getString(R.string.spam_detection_pref_key), X.m());
        }
        ((gfl) E.a).b.f("bugle");
        ((gfl) E.a).fR(R.xml.spam_preferences);
        Object obj = E.a;
        Preference l = ((gfl) obj).d().l(((cg) obj).S(R.string.spam_detection_pref_key));
        if (l != null) {
            l.Z();
            l.n = new zkp(E, 7);
            return;
    ...
    @Override // defpackage.zjd, defpackage.cg
            ...
            if (!this.ao) {
                ...
                if (this.aj == null) {
                    try {
                        ...
                        if (cgVar instanceof zmm) {
                            this.aj = new zmn((zmm) cgVar, (yyt) ((kqm) aS).a.oq.b(), (mho) ((kqm) aS).a.gD.b());
                            this.Z.c(new akli(this.an, this.al));
                        } else {
                            throw new IllegalStateException(hht.e(cgVar, zmn.class));
                        }
