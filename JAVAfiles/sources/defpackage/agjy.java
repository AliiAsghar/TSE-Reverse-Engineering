...
final class agjy {
    ...
    public static Object a(Future future, long j, TimeUnit timeUnit) {
        if (!a || (future instanceof ance) || (future instanceof agjx) || TimeUnit.NANOSECONDS.convert(j, timeUnit) <= 2147483647999999999L || future.isDone()) {
    ...
    public static RunnableScheduledFuture b(RunnableScheduledFuture runnableScheduledFuture) {
        if (a) {
            return new agjx(runnableScheduledFuture);
        }
