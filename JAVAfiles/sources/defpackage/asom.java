...
public final class asom {
    ...
    public static final String a(int i) {
        ...
        return asmt.j("0x%02x", Integer.valueOf(i));
    }
    ...
    public static final String b(boolean z, int i, int i2, int i3, int i4) {
            ...
            if (i3 != 2 && i3 != 3) {
                if (i3 != 4 && i3 != 6) {
                    if (i3 != 7 && i3 != 8) {
                        ...
                        if (i3 == 5) {
                            if ((i4 & 4) != 0) {
                                str = arsd.Z(str2, "HEADERS", "PUSH_PROMISE");
                            }
                            str = str2;
                        } else {
                            if (i3 == 0 && (i4 & 32) != 0) {
                                str = arsd.Z(str2, "PRIORITY", "COMPRESSED");
                            }
                            str = str2;
                        }
                    }
        ...
        return asmt.j("%s 0x%08x %5d %-13s %s", str3, Integer.valueOf(i), Integer.valueOf(i2), a2, str);
    }
}
