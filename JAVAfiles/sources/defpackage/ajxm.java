...
public final class ajxm extends ajxd {
    ...
    public final akbp k = new akbp<apdj<ajxl>, ajxc>() { // from class: ajxm.1
        ...
        private final void d(ajxl ajxlVar, ajxt ajxtVar) {
            ...
            if (ajxmVar.j) {
                akri s = aktp.s(ajxm.q);
                if (s.b()) {
                    i = ((Integer) s.a()).intValue();
                } else {
                    i = 0;
                }
                int i2 = i + 1;
                if (i2 > 10) {
                    if (ajxm.this.d.f()) {
                        name = ((Activity) ajxm.this.d.b()).getClass().getName();
                    } else {
                        name = ajxm.this.o.getClass().getName();
                    }
                    ((alvg) ((alvg) ajxm.a.h()).h("com/google/apps/tiktok/account/api/controller/AccountControllerViewModelBacked$1", "fallbackOrSetErrorDetectingInfiniteLoop", 376, "AccountControllerViewModelBacked.java")).t("A highly probable infinite loop detected in host: %s", new aomj(aomi.NO_USER_DATA, name));
                ...
                akrj b2 = akrl.b();
                b2.a(ajxm.q, Integer.valueOf(i2));
                akrh f = aktp.f("AccountController account error", ((akrl) b2).f());
                try {
                    if (ajxlVar.i) {
                        ajxm.this.g.j(ajxtVar);
                        f.close();
                        return;
                    } else {
                        ajxm.this.e.l(ajxtVar);
                        f.close();
                        return;
                    }
                } catch (Throwable th) {
        ...
        public final /* synthetic */ void a(Object obj, Throwable th) {
            ...
            ajxd.b(ajxlVar);
            if (!ajxlVar.equals(ajxm.this.m.a)) {
                return;
            }
            ajxm.this.k();
                            ...
                            if (i3 != 3) {
                                if (i3 != 4) {
                                    if (i3 == 5) {
                                        ajxm ajxmVar = ajxm.this;
                                        alog g = alobVar.g();
                                        ajyx b2 = ajxm.this.g.b(((Integer) algwVar.b()).intValue());
                                        ajxmVar.j();
                                        g.getClass();
                                        albo.T(!g.isEmpty());
                                        a aVar = ajxmVar.m;
                                        ...
                                        try {
                                            ListenableFuture f = ajxmVar.f(g, new ajxb(), true);
                                            if (!f.isDone()) {
                                                ajxmVar.g.k();
                                                ajxmVar.r(6, null, algw.i(g), alfd.a, true, algw.i(b2), f, i2);
                                            } else {
                                                ProtoParsers$InternalDontUse protoParsers$InternalDontUse = new ProtoParsers$InternalDontUse(null, ajxmVar.q(6, null, algw.i(g), alfd.a, true, algw.i(b2), i2));
                                                try {
                                                    ajxmVar.k.c(protoParsers$InternalDontUse, (ajxc) albo.bQ(f));
                                                } catch (ExecutionException e3) {
                                                    ajxmVar.k.a(protoParsers$InternalDontUse, e3.getCause());
                                                }
                                            }
                                            e.close();
                                            return;
                                ...
                                albo.T(z2);
                                ajxm.this.o(ajwt.a(i4), ajxlVar.g, i2);
                                return;
                            }
                        } else {
            ...
            if ((ajxlVar.b & 2) != 0) {
                ...
                if (th instanceof ajxt) {
                    ((alvg) ((alvg) ((alvg) ajxm.a.g()).g(th)).h("com/google/apps/tiktok/account/api/controller/AccountControllerViewModelBacked$1", "onFailure", 267, "AccountControllerViewModelBacked.java")).t("Failed to use %s.", a2);
                } else {
                    ((alvg) ((alvg) ((alvg) ajxm.a.h()).g(th)).h("com/google/apps/tiktok/account/api/controller/AccountControllerViewModelBacked$1", "onFailure", 270, "AccountControllerViewModelBacked.java")).t("Failed to use %s.", a2);
                }
            }
            ajxm.this.m();
        }
        ...
        public final /* synthetic */ void c(Object obj, Object obj2) {
            ...
            if ((ajxlVar.b & 2) != 0) {
                ...
                if (ajxcVar.d != null) {
                    ...
                    if (ajxm.this.e.c()) {
                        ajya.c(intent, ajwt.a(ajxm.this.e.a()));
                    }
                    ajxm.this.c.c().c(intent);
                    ajxm.this.g.c();
                    return;
                }
                if (ajxcVar.c != null) {
            ...
            if (ajyzVar.a) {
                ajxm ajxmVar = ajxm.this;
                ajxmVar.e.n(ajxcVar.a, ajxcVar.b, ajxbVar);
                ajxm.this.k();
            } else if (ajxm.this.c.e()) {
                if (ajyzVar.b) {
                    ajxm.this.e.m();
                }
                ...
                ajya.b(intent2);
                ajki.r(intent2, ajxm.this.l.a);
                intent2.addFlags(65536);
                ajxm.this.c.b().c(intent2);
            } else {
                ajxm.this.k();
                Intent intent3 = ajyzVar.c;
                ajxw ajxwVar = new ajxw();
                d(ajxlVar, ajxwVar);
                ((alvg) ((alvg) ((alvg) ajxm.a.g()).g(ajxwVar)).h("com/google/apps/tiktok/account/api/controller/AccountControllerViewModelBacked$1", "onSuccess", 197, "AccountControllerViewModelBacked.java")).t("Account with id %s does not fulfill all the requirements.", ajwtVar);
                ajxm.this.m();
                return;
            }
            ajxm.this.m();
    ...
    public static final aktp q = new aktp();
    public static final alvi a = alvi.m("AccountControllerImpl");

    /* compiled from: PG */
    /* loaded from: classes4.dex */
    public final class a extends eor {
        ajxl a;
        boolean b;
        boolean c;
        final ajxp d;

        public a(eog eogVar, armf armfVar) {
            final boolean booleanValue = ((Boolean) ((algw) ((apxx) armfVar).a).d(false)).booleanValue();
            ajxp ajxpVar = new ajxp();
            this.d = ajxpVar;
            Bundle bundle = (Bundle) eogVar.a("tiktok_account_controller_saved_instance_state");
            ajxpVar.c = bundle;
            if (bundle != null) {
                this.c = true;
                this.a = (ajxl) aowt.f(bundle, "state_latest_operation", ajxl.a, aozs.a());
                this.b = bundle.getBoolean("state_pending_op");
            }
            eogVar.d("tiktok_account_controller_saved_instance_state", new gjy() { // from class: ajxo
                @Override // defpackage.gjy
                public final Bundle a() {
                    Bundle bundle2 = new Bundle();
                    ajxm.a aVar = ajxm.a.this;
                    bundle2.putBoolean("state_pending_op", aVar.b);
                    aowt.i(bundle2, "state_latest_operation", aVar.a);
    ...
    public ajxm(aklj akljVar, ajxs ajxsVar, algw algwVar, ajyp ajypVar, akbo akboVar, agcp agcpVar, ajyy ajyyVar, aogy aogyVar, ajyc ajycVar, algw algwVar2, algw algwVar3) {
        this.o = akljVar;
        this.c = ajxsVar;
        this.d = algwVar;
        this.e = ajypVar;
        ...
        bool.getClass();
        ajypVar.k(this);
        akljVar.N().c(new akuj(new ajxn(this)));
        ajxsVar.d(new yjk(this, 9), new yjk(this, 10));
    }
    ...
    public final ListenableFuture h(int i) {
        ...
        try {
            ...
            if (a2 == -1) {
                ...
                ajwt a3 = ajwt.a(a2);
                ListenableFuture x = this.r.x(a3, this.l.c, this.c.a(), new ajxb());
                alfd alfdVar = alfd.a;
                e.b(x);
    ...
    public final void l(alog alogVar, ListenableFuture listenableFuture, int i) {
        ...
        ajxl q2 = q(2, null, i3, alfdVar2, false, alfdVar2, i);
        try {
            this.k.c(new ProtoParsers$InternalDontUse(null, q2), (ajxc) albo.bQ(listenableFuture));
        } catch (ExecutionException e) {
            this.k.a(new ProtoParsers$InternalDontUse(null, q2), e.getCause());
        }
    }
    ...
    public final void n(alog alogVar, int i) {
        ...
        ListenableFuture w = this.r.w(new ajyi(this.c.a()), alogVar, new ajxb());
        algw i3 = algw.i(alogVar);
        alfd alfdVar = alfd.a;
    ...
    public final void o(ajwt ajwtVar, boolean z, int i) {
        ...
        try {
            this.m.c = false;
            if (z) {
                x = this.r.u(ajwtVar, this.l.c, this.c.a(), new ajxb());
            } else {
                x = this.r.x(ajwtVar, this.l.c, this.c.a(), new ajxb());
            }
    ...
    /* JADX WARN: Type inference failed for: r8v11, types: [ajyx, java.lang.Object] */
    ...
    public final void r(int i, ajwt ajwtVar, algw algwVar, algw algwVar2, boolean z, algw algwVar3, ListenableFuture listenableFuture, int i2) {
        ajxl q2 = q(i, ajwtVar, algwVar, algwVar2, z, algwVar3, i2);
        this.m.b = true;
        try {
            this.f.k(new ahlp(listenableFuture), ahlp.m(q2), this.k);
