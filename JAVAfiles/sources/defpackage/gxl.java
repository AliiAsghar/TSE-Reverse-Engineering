...
public final class gxl extends gxe {
    public gxl(Context context, gpx gpxVar) {
    ...
    */
    public final /* bridge */ /* synthetic */ java.lang.Object b() {
        ...
        L3a:
            ...
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.gxl.b():java.lang.Object");
    }

    @Override // defpackage.gxe
    public final void c(Intent intent) {
        if (intent.getAction() != null) {
            gsy.a().c(gxm.a, "Received ".concat(String.valueOf(intent.getAction())));
