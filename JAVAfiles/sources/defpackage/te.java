...
public final class te extends Drawable {
    public float a;
    public float b;
    ...
    public te(ColorStateList colorStateList, float f) {
        this.a = f;
    ...
    public final void a(Rect rect) {
        ...
        this.h.set(rect);
        if (this.c) {
            this.h.inset((int) Math.ceil(tf.a(this.b, this.a, this.d)), (int) Math.ceil(tf.b(this.b, this.a, this.d)));
            this.g.set(this.h);
        }
    }
