...
public final class atbt implements PrivateKey, Key {
    private static final long serialVersionUID = 1;
    private transient asxf a;
    private transient ASN1Set b;

    public atbt(PrivateKeyInfo privateKeyInfo) {
        a(privateKeyInfo);
    }

    private final void a(PrivateKeyInfo privateKeyInfo) {
        this.b = privateKeyInfo.b;
        this.a = (asxf) atow.au(privateKeyInfo);
    }
    ...
    public final boolean equals(Object obj) {
        ...
        if (obj instanceof atbt) {
            return Arrays.equals(this.a.a(), ((atbt) obj).a.a());
        }
        return false;
    }
