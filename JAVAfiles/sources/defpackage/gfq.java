...
public final class gfq {
    ...
    public static final Preference a(XmlPullParser xmlPullParser, PreferenceGroup preferenceGroup, Context context, Object[] objArr, gfu gfuVar, String[] strArr) {
        int next;
        synchronized (objArr) {
                ...
                try {
                    ...
                    if (next == 2) {
                        ...
                        if (preferenceGroup == null) {
                            preferenceGroup2.C(gfuVar);
                            preferenceGroup = preferenceGroup2;
                        }
                        b(xmlPullParser, preferenceGroup, asAttributeSet, context, objArr, gfuVar, strArr);
                    }
    ...
    private static final void b(XmlPullParser xmlPullParser, Preference preference, AttributeSet attributeSet, Context context, Object[] objArr, gfu gfuVar, String[] strArr) {
            ...
            if (next != 1) {
                if (next == 2) {
                    ...
                    if ("intent".equals(name)) {
                        ...
                        b(xmlPullParser, d, attributeSet, context, objArr, gfuVar, strArr);
                    }
                }
            } else {
                return;
            ...
            try {
                try {
                    ...
                    if (strArr != null) {
                        ...
                        if (cls == null) {
                            if (e == null) {
                                throw new InflateException(a.cf(str, attributeSet, ": Error inflating class "));
                            }
                            throw e;
                        }
                    } else {
                    ...
                    InflateException inflateException = new InflateException(a.cf(str, attributeSet, ": Error inflating class "));
    ...
    private static final Preference d(String str, AttributeSet attributeSet, Context context, Object[] objArr, String[] strArr) {
        try {
            ...
            InflateException inflateException = new InflateException(a.cf(str, attributeSet, ": Error inflating class (not found)"));
            inflateException.initCause(e2);
            throw inflateException;
        } catch (Exception e3) {
            InflateException inflateException2 = new InflateException(a.cf(str, attributeSet, ": Error inflating class "));
            inflateException2.initCause(e3);
            throw inflateException2;
        }
    }
