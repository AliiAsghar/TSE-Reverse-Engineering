...
public final class acly {
    ...
    public static acly a(Context context) {
        abhg.m(context);
        synchronized (acly.class) {
            if (c == null) {
                c = new acly(context);
            }
        }
    ...
    static final boolean c(PackageInfo packageInfo, boolean z) {
        ...
        if (z) {
            return e(packageInfo, a, b);
        }
        return e(packageInfo, a);
    }
    ...
    public final boolean b() {
        ...
        boolean z;
        try {
            packageInfo = abvn.b(this.d).e("com.google.android.wearable.app.cn", 64);
