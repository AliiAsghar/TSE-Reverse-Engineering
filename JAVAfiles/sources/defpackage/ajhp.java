...
public final class ajhp extends ajhn {
    private StateListAnimator E;

    public ajhp(FloatingActionButton floatingActionButton, asqc asqcVar) {
        super(floatingActionButton, asqcVar);
    }
    ...
    public final void g(float f, float f2, float f3) {
        if (this.B.getStateListAnimator() == this.E) {
            ...
            arrayList.add(ObjectAnimator.ofFloat(this.B, (Property<FloatingActionButton, Float>) View.TRANSLATION_Z, brg.a).setDuration(100L));
            animatorSet.playSequentially((Animator[]) arrayList.toArray(new Animator[0]));
            animatorSet.setInterpolator(a);
            stateListAnimator.addState(j, animatorSet);
            stateListAnimator.addState(k, p(brg.a, brg.a));
