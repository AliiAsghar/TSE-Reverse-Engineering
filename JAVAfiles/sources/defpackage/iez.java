...
public final class iez extends ife implements akkh, apxq, akkf, aklk, akrw {
    private ifb a;
    private boolean ag;
    private Context d;
    ...
    public final View K(LayoutInflater layoutInflater, ViewGroup viewGroup, Bundle bundle) {
        ...
        try {
            ...
            composeView.a(new cdj(849238072, true, new gck(E, 4)));
            akqj.p();
            return composeView;
        } catch (Throwable th) {
            try {
    ...
    @Override // defpackage.ife, defpackage.aiuc, defpackage.cg
    ...
    @Override // defpackage.ife, defpackage.aklf, defpackage.cg
        ...
        try {
            if (!this.ag) {
                ...
                if (this.a == null) {
                    try {
                        Object aS = aS();
                        this.a = new ifb((armf) ((kqm) aS).f, (armf) ((kqm) aS).g);
    ...
    @Override // defpackage.ife, defpackage.cg
