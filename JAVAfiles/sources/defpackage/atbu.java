...
public final class atbu implements PublicKey, Key {
    private static final long serialVersionUID = 1;
    private transient asxg a;

    public atbu(SubjectPublicKeyInfo subjectPublicKeyInfo) {
        a(subjectPublicKeyInfo);
    }

    private final void a(SubjectPublicKeyInfo subjectPublicKeyInfo) {
        this.a = (asxg) atab.a(subjectPublicKeyInfo);
    }
    ...
    public final boolean equals(Object obj) {
        ...
        if (obj instanceof atbu) {
            return Arrays.equals(this.a.a(), ((atbu) obj).a.a());
        }
        return false;
    }
