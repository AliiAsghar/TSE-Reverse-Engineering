...
abstract class atio implements atjg, atje {
    protected final atfy a;
    protected final int b;
    protected final boolean c;

    public atio(atfy atfyVar, int i, boolean z) {
        this.a = atfyVar;
        this.b = i;
        this.c = z;
    }
    ...
    public int c(atja atjaVar, CharSequence charSequence, int i) {
        int i2;
        int i3;
        int i4;
        char charAt;
