...
public final class agjx implements RunnableScheduledFuture {
    private final RunnableScheduledFuture a;

    public agjx(RunnableScheduledFuture runnableScheduledFuture) {
    ...
    public final /* bridge */ /* synthetic */ int compareTo(Delayed delayed) {
        ...
        if (delayed2 instanceof agjx) {
            return this.a.compareTo(((agjx) delayed2).a);
        }
    ...
    public final Object get(long j, TimeUnit timeUnit) {
        return agjy.a(this.a, j, timeUnit);
    }
}
