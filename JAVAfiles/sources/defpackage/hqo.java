...
public final class hqo implements hqj {
    public static final Bitmap.Config[] a;
    public static final Bitmap.Config[] b;
    public static final Bitmap.Config[] c;
    public static final Bitmap.Config[] d;
    public static final Bitmap.Config[] e;
    public final hqn f = new hqn();
    public final hqd g = new hqd();
    ...
    public final String a(Bitmap bitmap) {
        return c(hyv.a(bitmap), bitmap.getConfig());
    }

    @Override // defpackage.hqj
    public final String b(int i, int i2, Bitmap.Config config) {
        return c(hyv.b(i, i2, config), config);
    }
