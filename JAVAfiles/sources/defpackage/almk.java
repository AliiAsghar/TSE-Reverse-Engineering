...
public final class almk extends alsr implements Serializable {
    private static final long serialVersionUID = 0;
    final Comparator[] a;

    public almk(Comparator comparator, Comparator comparator2) {
    ...
    public final boolean equals(Object obj) {
        ...
        if (obj instanceof almk) {
            return Arrays.equals(this.a, ((almk) obj).a);
        }
        return false;
    }
