...
public final class kum extends kwn implements akkh, apxq, akkf, aklk, akrw {
    private kun a;
    private boolean ag;
    private Context d;
    ...
    @Override // defpackage.kwn, defpackage.aiuc, defpackage.cg
    ...
    @Override // defpackage.kwn, defpackage.aklf, defpackage.cg
            ...
            if (!this.ag) {
                ...
                if (this.a == null) {
                    try {
                        ...
                        if (cgVar instanceof kum) {
                            this.a = new kun((kum) cgVar, ((kql) aS).ej.b);
                            this.Z.c(new akli(this.c, this.e));
                        } else {
                            throw new IllegalStateException(hht.e(cgVar, kun.class));
                        }
    ...
    @Override // defpackage.kwn, defpackage.cg
