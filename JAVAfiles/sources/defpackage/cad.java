...
public final class cad {
    ...
    public static final bwa k(ArrayList arrayList, int i, int i2) {
        int i3 = i(arrayList, i, i2);
        if (i3 >= 0) {
            return (bwa) arrayList.get(i3);
        }
        return null;
    }
    ...
    public static final boolean r(int[] iArr, int i) {
        if ((iArr[(i * 5) + 1] & VCardConfig.FLAG_APPEND_TYPE_PARAM) != 0) {
            return true;
        }
        return false;
    }
    ...
    public static final boolean s(int[] iArr, int i) {
        if ((iArr[(i * 5) + 1] & VCardConfig.FLAG_REFRAIN_QP_TO_NAME_PROPERTIES) != 0) {
            return true;
        }
        return false;
    }
    ...
    public static final boolean t(int[] iArr, int i) {
        if ((iArr[(i * 5) + 1] & VCardConfig.FLAG_CONVERT_PHONETIC_NAME_STRINGS) != 0) {
            return true;
        }
        return false;
    }
