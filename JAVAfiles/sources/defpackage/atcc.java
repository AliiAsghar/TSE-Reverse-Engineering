...
public final class atcc implements PrivateKey, Key {
    private static final long serialVersionUID = 1;
    private transient asxy a;
    private transient ASN1Set b;

    public atcc(PrivateKeyInfo privateKeyInfo) {
        a(privateKeyInfo);
    }

    private final void a(PrivateKeyInfo privateKeyInfo) {
        this.b = privateKeyInfo.b;
        this.a = (asxy) atow.au(privateKeyInfo);
    }
    ...
    public final boolean equals(Object obj) {
        ...
        if (obj instanceof atcc) {
            return Arrays.equals(this.a.a(), ((atcc) obj).a.a());
        }
        return false;
    }
