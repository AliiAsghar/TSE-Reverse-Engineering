...
public final class abfq extends ClickableSpan {
    final /* synthetic */ abfp a;

    public abfq(abfp abfpVar) {
        this.a = abfpVar;
    }
    ...
    public final void onClick(View view) {
        ...
        Uri parse = Uri.parse(context.getString(R.string.welcome_smarts_learn_more_url, yhx.b(context).getLanguage()));
