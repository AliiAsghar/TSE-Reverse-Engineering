...
public final class asfm {
    ...
    static {
        ...
        try {
            O = Class.forName("arpq").getCanonicalName();
        } catch (Throwable th) {
            O = aqil.O(th);
        }
        if (armq.c(O) != null) {
        ...
        b = (String) O;
        try {
            O2 = Class.forName("asfm").getCanonicalName();
        } catch (Throwable th2) {
            O2 = aqil.O(th2);
        }
        if (armq.c(O2) != null) {
    ...
    */
    public static final java.lang.Throwable a(java.lang.Throwable r10, defpackage.arpt r11) {
        /*
            Method dump skipped, instructions count: 276
            To view this dump change 'Code comments level' option to 'DEBUG'
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.asfm.a(java.lang.Throwable, arpt):java.lang.Throwable");
    }
    ...
    public static final Throwable b(Throwable th) {
        ...
        if (arwh.b && (a2 = asew.a(th)) != null) {
            ...
            if (i2 >= 0) {
                while (true) {
                    int i3 = i2 - 1;
                    if (d.F(c, stackTrace[i2].getClassName())) {
                        break;
                    }
                    if (i3 < 0) {
                        break;
    ...
    public static final Throwable c(Throwable th) {
        ...
        if (cause != null) {
            if (d.F(cause.getClass(), th.getClass())) {
    ...
    public static final boolean d(StackTraceElement stackTraceElement) {
        return arsd.z(stackTraceElement.getClassName(), "_COROUTINE", false);
    }

    private static final int e(StackTraceElement[] stackTraceElementArr, String str) {
        int length = stackTraceElementArr.length;
        for (int i = 0; i < length; i++) {
            if (d.F(str, stackTraceElementArr[i].getClassName())) {
                return i;
            }
        }
        return -1;
