...
public final class lda extends aglz {
    public String I;
    public String K;
    public String L;
    public String M;
    ...
    public final /* bridge */ /* synthetic */ void c(agmq agmqVar) {
        ...
        boolean z11 = false;
        if (lbzVar.db(0)) {
            this.Y = new ConversationIdType(lbzVar.getLong(lbzVar.cI(0, ldf.a)));
            fE(0);
        }
        if (lbzVar.db(1)) {
            this.a = lbzVar.getString(lbzVar.cI(1, ldf.a));
            fE(1);
        }
        if (lbzVar.db(2)) {
            this.b = yta.a(lbzVar.getString(lbzVar.cI(2, ldf.a)));
            fE(2);
        }
        if (lbzVar.db(3)) {
            this.c = yta.a(lbzVar.getString(lbzVar.cI(3, ldf.a)));
            fE(3);
        }
        if (lbzVar.db(4)) {
            String string = lbzVar.getString(lbzVar.cI(4, ldf.a));
            if (string == null) {
                parse2 = null;
            } else {
        ...
        if (lbzVar.db(5)) {
            this.e = lbzVar.getString(lbzVar.cI(5, ldf.a));
            fE(5);
        }
        if (lbzVar.db(6)) {
            if (lbzVar.getInt(lbzVar.cI(6, ldf.a)) == 1) {
                z10 = true;
            } else {
                z10 = false;
            }
        ...
        if (lbzVar.db(7)) {
            this.g = yta.a(lbzVar.getString(lbzVar.cI(7, ldf.a)));
            fE(7);
        }
        if (lbzVar.db(8)) {
            this.h = yta.a(lbzVar.getString(lbzVar.cI(8, ldf.a)));
            fE(8);
        }
        if (lbzVar.db(9)) {
            String string2 = lbzVar.getString(lbzVar.cI(9, ldf.a));
            if (string2 == null) {
                parse = null;
            } else {
        ...
        if (lbzVar.db(10)) {
            this.j = lbzVar.getString(lbzVar.cI(10, ldf.a));
            fE(10);
        }
        if (lbzVar.db(11)) {
            this.k = tqc.a(lbzVar.getInt(lbzVar.cI(11, ldf.a)));
            fE(11);
        }
        if (lbzVar.db(12)) {
            this.Z = lbzVar.getLong(lbzVar.cI(12, ldf.a));
            fE(12);
        }
        if (lbzVar.db(13)) {
            this.l = lbzVar.getString(lbzVar.cI(13, ldf.a));
            fE(13);
        }
        if (lbzVar.db(14)) {
            this.m = lbzVar.getString(lbzVar.cI(14, ldf.a));
            fE(14);
        }
        if (lbzVar.db(15)) {
            this.aa = lbzVar.getString(lbzVar.cI(15, ldf.a));
            fE(15);
        }
        if (lbzVar.db(16)) {
            this.n = lbzVar.getInt(lbzVar.cI(16, ldf.a));
            fE(16);
        }
        if (lbzVar.db(17)) {
            if (lbzVar.getInt(lbzVar.cI(17, ldf.a)) == 1) {
                z9 = true;
            } else {
                z9 = false;
            }
        ...
        if (lbzVar.db(18)) {
            if (lbzVar.getInt(lbzVar.cI(18, ldf.a)) == 1) {
                z8 = true;
            } else {
                z8 = false;
            }
        ...
        if (lbzVar.db(19)) {
            this.ab = lbzVar.getInt(lbzVar.cI(19, ldf.a));
            fE(19);
        }
        if (lbzVar.db(20)) {
            this.q = lbzVar.getLong(lbzVar.cI(20, ldf.a));
            fE(20);
        }
        if (lbzVar.db(21)) {
            this.r = lbzVar.getInt(lbzVar.cI(21, ldf.a));
            fE(21);
        }
        if (lbzVar.db(22)) {
            this.s = lbzVar.getInt(lbzVar.cI(22, ldf.a));
            fE(22);
        }
        if (lbzVar.db(23)) {
            if (lbzVar.getInt(lbzVar.cI(23, ldf.a)) == 1) {
                z7 = true;
            } else {
                z7 = false;
            }
        ...
        if (lbzVar.db(24)) {
            if (lbzVar.getInt(lbzVar.cI(24, ldf.a)) == 1) {
                z6 = true;
            } else {
                z6 = false;
            }
        ...
        if (lbzVar.db(25)) {
            this.v = yta.a(lbzVar.getString(lbzVar.cI(25, ldf.a)));
            fE(25);
        }
        if (lbzVar.db(26)) {
            if (lbzVar.getInt(lbzVar.cI(26, ldf.a)) == 1) {
                z5 = true;
            } else {
                z5 = false;
            }
        ...
        if (lbzVar.db(27)) {
            if (lbzVar.getInt(lbzVar.cI(27, ldf.a)) == 1) {
                z4 = true;
            } else {
                z4 = false;
            }
        ...
        if (lbzVar.db(28)) {
            ...
            int i = lbzVar.getInt(lbzVar.cI(28, ldf.a));
            if (i < values.length) {
                this.y = values[i];
                fE(28);
            } else {
        ...
        if (lbzVar.db(29)) {
            this.z = new MessageIdType(lbzVar.getLong(lbzVar.cI(29, ldf.a)));
            fE(29);
        }
        if (lbzVar.db(30)) {
            this.A = lbzVar.getLong(lbzVar.cI(30, ldf.a));
            fE(30);
        }
        if (lbzVar.db(31)) {
            this.B = lbzVar.getLong(lbzVar.cI(31, ldf.a));
            fE(31);
        }
        if (lbzVar.db(32)) {
            this.C = lbzVar.getInt(lbzVar.cI(32, ldf.a));
            fE(32);
        }
        if (lbzVar.db(33)) {
            this.D = lbzVar.getInt(lbzVar.cI(33, ldf.a));
            fE(33);
        }
        if (lbzVar.db(34)) {
            if (lbzVar.getInt(lbzVar.cI(34, ldf.a)) == 1) {
                z3 = true;
            } else {
                z3 = false;
            }
        ...
        if (lbzVar.db(35)) {
            this.F = lbzVar.getInt(lbzVar.cI(35, ldf.a));
            fE(35);
        }
        if (lbzVar.db(36)) {
            this.G = lbzVar.getInt(lbzVar.cI(36, ldf.a));
            fE(36);
        }
        if (lbzVar.db(37)) {
            this.H = lbzVar.getInt(lbzVar.cI(37, ldf.a));
            fE(37);
        }
        if (lbzVar.db(38)) {
            this.I = lbzVar.getString(lbzVar.cI(38, ldf.a));
            fE(38);
        }
        if (lbzVar.db(39)) {
            this.J = lbzVar.getInt(lbzVar.cI(39, ldf.a));
            fE(39);
        }
        if (lbzVar.db(40)) {
            this.K = aabr.bb(lbzVar.getString(lbzVar.cI(40, ldf.a)));
            fE(40);
        }
        if (lbzVar.db(41)) {
            this.L = yta.a(lbzVar.getString(lbzVar.cI(41, ldf.a)));
            fE(41);
        }
        if (lbzVar.db(42)) {
            this.M = yta.a(lbzVar.getString(lbzVar.cI(42, ldf.a)));
            fE(42);
        }
        if (lbzVar.db(43)) {
            this.ac = lbzVar.getLong(lbzVar.cI(43, ldf.a));
            fE(43);
        }
        if (lbzVar.db(44)) {
            this.N = yta.a(lbzVar.getString(lbzVar.cI(44, ldf.a)));
            fE(44);
        }
        if (lbzVar.db(45)) {
            this.O = yta.a(lbzVar.getString(lbzVar.cI(45, ldf.a)));
            fE(45);
        }
        if (lbzVar.db(46)) {
            this.P = lbzVar.getString(lbzVar.cI(46, ldf.a));
            fE(46);
        }
        if (lbzVar.db(47)) {
            this.Q = lbzVar.getString(lbzVar.cI(47, ldf.a));
            fE(47);
        }
        if (lbzVar.db(48)) {
            this.R = lbzVar.getLong(lbzVar.cI(48, ldf.a));
            fE(48);
        }
        if (lbzVar.db(49)) {
            if (lbzVar.getInt(lbzVar.cI(49, ldf.a)) == 1) {
                z2 = true;
            } else {
                z2 = false;
            }
        ...
        if (lbzVar.db(50)) {
            this.T = lbzVar.getString(lbzVar.cI(50, ldf.a));
            fE(50);
        }
        if (lbzVar.db(51)) {
            if (lbzVar.getInt(lbzVar.cI(51, ldf.a)) == 1) {
                z = true;
            } else {
                z = false;
            }
        ...
        if (lbzVar.db(52)) {
            if (lbzVar.getInt(lbzVar.cI(52, ldf.a)) == 1) {
                z11 = true;
            }
            this.V = z11;
            fE(52);
        ...
        if (lbzVar.db(53)) {
            ...
            int i2 = lbzVar.getInt(lbzVar.cI(53, ldf.a));
        ...
        if (lbzVar.db(54)) {
            this.X = lbzVar.getLong(lbzVar.cI(54, ldf.a));
            fE(54);
        }
    }
    ...
    public final boolean equals(Object obj) {
        ...
        lda ldaVar = (lda) obj;
        if (super.aC(ldaVar.cJ) && Objects.equals(this.Y, ldaVar.Y) && Objects.equals(this.a, ldaVar.a) && Objects.equals(this.b, ldaVar.b) && Objects.equals(this.c, ldaVar.c) && Objects.equals(this.d, ldaVar.d) && Objects.equals(this.e, ldaVar.e) && this.f == ldaVar.f && Objects.equals(this.g, ldaVar.g) && Objects.equals(this.h, ldaVar.h) && Objects.equals(this.i, ldaVar.i) && Objects.equals(this.j, ldaVar.j) && this.k == ldaVar.k && this.Z == ldaVar.Z && Objects.equals(this.l, ldaVar.l) && Objects.equals(this.m, ldaVar.m) && Objects.equals(this.aa, ldaVar.aa) && this.n == ldaVar.n && this.o == ldaVar.o && this.p == ldaVar.p && this.ab == ldaVar.ab && this.q == ldaVar.q && this.r == ldaVar.r && this.s == ldaVar.s && this.t == ldaVar.t && this.u == ldaVar.u && Objects.equals(this.v, ldaVar.v) && this.w == ldaVar.w && this.x == ldaVar.x && this.y == ldaVar.y && Objects.equals(this.z, ldaVar.z) && this.A == ldaVar.A && this.B == ldaVar.B && this.C == ldaVar.C && this.D == ldaVar.D && this.E == ldaVar.E && this.F == ldaVar.F && this.G == ldaVar.G && this.H == ldaVar.H && Objects.equals(this.I, ldaVar.I) && this.J == ldaVar.J && Objects.equals(this.K, ldaVar.K) && Objects.equals(this.L, ldaVar.L) && Objects.equals(this.M, ldaVar.M) && this.ac == ldaVar.ac && Objects.equals(this.N, ldaVar.N) && Objects.equals(this.O, ldaVar.O) && Objects.equals(this.P, ldaVar.P) && Objects.equals(this.Q, ldaVar.Q) && this.R == ldaVar.R && this.S == ldaVar.S && Objects.equals(this.T, ldaVar.T) && this.U == ldaVar.U && this.V == ldaVar.V && this.W == ldaVar.W && this.X == ldaVar.X) {
            return true;
        }
        return false;
    }
    ...
    public final String toString() {
        if (((aglz.a) akec.w(agnc.b, aglz.a.class)).QY().a()) {
            return String.format(Locale.US, "%s", "SuperSortQuery -- REDACTED");
        }
        return a();
    }
}
