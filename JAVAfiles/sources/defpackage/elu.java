...
final class elu extends InputStream implements DataInput, InputStreamRetargetInterface {
    ...
    public final void b(int i) {
        ...
        while (i2 < i) {
            ...
            if (skip <= 0) {
                ...
                if (skip == -1) {
                    throw new EOFException(a.cb(i, "Reached EOF while skipping ", " bytes."));
                }
            }
            i2 += skip;
        }
    ...
    public elu(InputStream inputStream, ByteOrder byteOrder) {
        DataInputStream dataInputStream = new DataInputStream(inputStream);
        this.a = dataInputStream;
        dataInputStream.mark(0);
        this.b = 0;
        this.c = byteOrder;
        this.d = inputStream instanceof elu ? ((elu) inputStream).d : -1;
    }
    ...
    public elu(byte[] bArr) {
        this(new ByteArrayInputStream(bArr), ByteOrder.BIG_ENDIAN);
        this.d = bArr.length;
    }

    public elu(InputStream inputStream, byte[] bArr) {
        this(inputStream);
    ...
    public elu(byte[] bArr, byte[] bArr2) {
        this(bArr);
        this.a.mark(Integer.MAX_VALUE);
    }
}
