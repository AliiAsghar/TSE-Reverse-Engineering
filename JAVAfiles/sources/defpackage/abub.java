...
public final class abub {
    ...
    public static String b(Context context, int i) {
        ...
        if (i != 1) {
            if (i != 2) {
                ...
                return resources.getString(com.google.android.apps.messaging.R.string.common_google_play_services_enable_button);
            }
            return resources.getString(com.google.android.apps.messaging.R.string.common_google_play_services_update_button);
        }
        return resources.getString(com.google.android.apps.messaging.R.string.common_google_play_services_install_button);
    }
    ...
    public static String c(Context context, int i) {
        ...
        if (i != 1) {
            ...
            if (abvd.c(context)) {
                return resources.getString(com.google.android.apps.messaging.R.string.common_google_play_services_wear_update_text);
            }
            return resources.getString(com.google.android.apps.messaging.R.string.common_google_play_services_update_text, a2);
        }
    ...
    public static String f(Context context, String str) {
        ...
        synchronized (vlVar) {
            ...
            String str2 = (String) vlVar.get(str);
            if (str2 != null) {
                return str2;
            }
            int i = abqp.c;
            ...
            if (identifier == 0) {
                Log.w("GoogleApiAvailability", a.cp(str, "Missing resource: "));
                return null;
            }
            String string = resources.getString(identifier);
            if (TextUtils.isEmpty(string)) {
                Log.w("GoogleApiAvailability", a.cp(str, "Got empty resource: "));
                return null;
            }
            a.put(str, string);
            return string;
