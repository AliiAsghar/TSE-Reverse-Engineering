...
public final class ansx {
    ...
    static answ a(answ answVar, answ answVar2, BigInteger bigInteger, BigInteger bigInteger2) {
        if (answVar.a()) {
            return answVar2;
        }
        if (answVar2.a()) {
        ...
        BigInteger bigInteger3 = answVar.d;
        BigInteger mod = bigInteger3.multiply(bigInteger3).mod(bigInteger2);
        BigInteger bigInteger4 = answVar2.d;
        BigInteger mod2 = bigInteger4.multiply(bigInteger4).mod(bigInteger2);
        BigInteger mod3 = answVar.b.multiply(mod2).mod(bigInteger2);
        BigInteger mod4 = answVar2.b.multiply(mod).mod(bigInteger2);
        BigInteger mod5 = answVar.c.multiply(answVar2.d).mod(bigInteger2).multiply(mod2).mod(bigInteger2);
        BigInteger mod6 = answVar2.c.multiply(answVar.d).mod(bigInteger2).multiply(mod).mod(bigInteger2);
        if (mod3.equals(mod4)) {
            if (!mod5.equals(mod6)) {
                return answ.a;
            }
            return b(answVar, bigInteger, bigInteger2);
        }
        ...
        BigInteger add = answVar.d.add(answVar2.d);
        return new answ(mod12, mod13, add.multiply(add).mod(bigInteger2).subtract(mod).subtract(mod2).multiply(mod7).mod(bigInteger2));
    }

    static answ b(answ answVar, BigInteger bigInteger, BigInteger bigInteger2) {
        if (answVar.c.equals(BigInteger.ZERO)) {
            return answ.a;
        }
        BigInteger bigInteger3 = answVar.b;
        BigInteger mod = bigInteger3.multiply(bigInteger3).mod(bigInteger2);
        BigInteger bigInteger4 = answVar.c;
        BigInteger mod2 = bigInteger4.multiply(bigInteger4).mod(bigInteger2);
        BigInteger mod3 = mod2.multiply(mod2).mod(bigInteger2);
        BigInteger bigInteger5 = answVar.d;
        BigInteger mod4 = bigInteger5.multiply(bigInteger5).mod(bigInteger2);
        BigInteger add = answVar.b.add(mod2);
        ...
        BigInteger add3 = answVar.c.add(answVar.d);
        return new answ(mod5, mod6, add3.multiply(add3).mod(bigInteger2).subtract(mod2).subtract(mod4).mod(bigInteger2));
    }

    static answ c(ECPoint eCPoint, BigInteger bigInteger) {
        if (eCPoint.equals(ECPoint.POINT_INFINITY)) {
            return answ.a;
        }
        BigInteger mod = new BigInteger(1, anud.b((bigInteger.bitLength() + 8) / 8)).mod(bigInteger);
        BigInteger mod2 = mod.multiply(mod).mod(bigInteger);
        return new answ(eCPoint.getAffineX().multiply(mod2).mod(bigInteger), eCPoint.getAffineY().multiply(mod2.multiply(mod).mod(bigInteger)).mod(bigInteger), mod);
    }
    ...
    public static ECPoint e(BigInteger bigInteger, ECParameterSpec eCParameterSpec) {
        ...
        if (bigInteger.signum() == 1) {
            if (bigInteger.compareTo(eCParameterSpec.getOrder()) < 0) {
                ...
                answ c2 = c(ECPoint.POINT_INFINITY, d2);
                answ c3 = c(generator, d2);
