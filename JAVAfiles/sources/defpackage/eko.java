...
public final class eko extends SpannableStringBuilder {
    private final Class a;
    private final List b;

    public eko(Class cls, CharSequence charSequence) {
        super(charSequence);
        this.b = new ArrayList();
        this.a = cls;
    }

    private final ekn c(Object obj) {
        for (int i = 0; i < this.b.size(); i++) {
            ekn eknVar = (ekn) this.b.get(i);
            if (eknVar.a == obj) {
                return eknVar;
            }
        }
    ...
    private final void d() {
        for (int i = 0; i < this.b.size(); i++) {
            ((ekn) this.b.get(i)).b.decrementAndGet();
        }
    }
    ...
    public final void a() {
        for (int i = 0; i < this.b.size(); i++) {
            ((ekn) this.b.get(i)).b.incrementAndGet();
        }
    }
    ...
    public final void b() {
        d();
        for (int i = 0; i < this.b.size(); i++) {
            ((ekn) this.b.get(i)).onTextChanged(this, 0, length(), length());
        }
    }
    ...
    public final Object[] getSpans(int i, int i2, Class cls) {
        if (e(cls)) {
            ekn[] eknVarArr = (ekn[]) super.getSpans(i, i2, ekn.class);
            Object[] objArr = (Object[]) Array.newInstance((Class<?>) cls, eknVarArr.length);
            for (int i3 = 0; i3 < eknVarArr.length; i3++) {
                objArr[i3] = eknVarArr[i3].a;
            }
            return objArr;
        }
    ...
    public final CharSequence subSequence(int i, int i2) {
        return new eko(this.a, this, i, i2);
    }
    ...
    public eko(Class cls, CharSequence charSequence, int i, int i2) {
