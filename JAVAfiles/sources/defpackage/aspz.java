...
public final class aspz extends asql {
    private final X509TrustManager a;
    private final X509TrustManagerExtensions b;

    public aspz(X509TrustManager x509TrustManager, X509TrustManagerExtensions x509TrustManagerExtensions) {
    ...
    public final boolean equals(Object obj) {
        if ((obj instanceof aspz) && ((aspz) obj).a == this.a) {
            return true;
        }
        return false;
    }
