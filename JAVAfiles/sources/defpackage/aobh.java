...
public final class aobh implements annh {
    private final byte[] a;
    private final byte[] b;
    private final /* synthetic */ int c;
    private final Object d;

    public aobh(annh annhVar, byte[] bArr, byte[] bArr2, int i) {
        this.c = i;
        this.d = annhVar;
        this.a = bArr;
        this.b = bArr2;
    ...
    public static byte[] b(anua anuaVar) {
        if (anuaVar.d.equals(anxp.LEGACY)) {
            return new byte[]{0};
        }
        return new byte[0];
    }

    public static byte[] c(anua anuaVar) {
        ...
        if (ordinal != 1) {
            ...
            return antr.a(anuaVar.e.intValue()).c();
        }
        return antr.b(anuaVar.e.intValue()).c();
    }
            ...
            while (true) {
                ...
                if (i4 != i5) {
                    if (i4 < i5) {
                        ...
                        long b3 = ansu.b(digest, i2) & 2097151;
                        long c4 = ansu.c(digest, 2) >> 5;
                        long b4 = ansu.b(digest, 5) >> 2;
                        long c5 = ansu.c(digest, 7) >> 7;
                        long c6 = ansu.c(digest, 10) >> 4;
                        long b5 = ansu.b(digest, 13) >> c2;
                        long c7 = ansu.c(digest, 15) >> 6;
                        long b6 = ansu.b(digest, 18) >> 3;
                        long b7 = ansu.b(digest, 21) & 2097151;
                        long c8 = ansu.c(digest, 23) >> 5;
                        long b8 = ansu.b(digest, 26) >> 2;
                        long c9 = ansu.c(digest, 28) >> 7;
                        long c10 = ansu.c(digest, 31) >> 4;
                        long b9 = ansu.b(digest, 34) >> c2;
                        long c11 = ansu.c(digest, 36) >> 6;
                        long b10 = ansu.b(digest, 39) >> 3;
                        long b11 = ansu.b(digest, 42) & 2097151;
                        long c12 = ansu.c(digest, 44) >> 5;
                        long b12 = (ansu.b(digest, 47) >> 2) & 2097151;
                        long c13 = (ansu.c(digest, 49) >> 7) & 2097151;
                        long c14 = (ansu.c(digest, 52) >> 4) & 2097151;
                        long b13 = (ansu.b(digest, 55) >> c2) & 2097151;
                        long c15 = (ansu.c(digest, 57) >> 6) & 2097151;
                        long c16 = ansu.c(digest, 60) >> 3;
                        ...
                        ansz.h(jArr4, l);
                        ansz.b(jArr5, jArr4, ansv.a);
                        ansz.i(jArr4, jArr4, jArr2);
                        ansz.j(jArr5, jArr5, jArr2);
                        long[] jArr8 = new long[10];
                        ansz.h(jArr8, jArr5);
                        ansz.b(jArr8, jArr8, jArr5);
                        ansz.h(jArr, jArr8);
                        ansz.b(jArr, jArr, jArr5);
                        ansz.b(jArr, jArr, jArr4);
                        long[] jArr9 = new long[10];
                        long[] jArr10 = new long[10];
                        long[] jArr11 = new long[10];
                        ansz.h(jArr9, jArr);
                        ansz.h(jArr10, jArr9);
                        ansz.h(jArr10, jArr10);
                        ansz.b(jArr10, jArr, jArr10);
                        ansz.b(jArr9, jArr9, jArr10);
                        ansz.h(jArr9, jArr9);
                        ansz.b(jArr9, jArr10, jArr9);
                        ansz.h(jArr10, jArr9);
                        ...
                        ansz.b(jArr10, jArr10, jArr9);
                        ansz.h(jArr11, jArr10);
                        for (int i8 = 1; i8 < 20; i8++) {
                            ansz.h(jArr11, jArr11);
                        }
                        ansz.b(jArr10, jArr11, jArr10);
                        ansz.h(jArr10, jArr10);
                        ...
                        ansz.h(jArr9, jArr9);
                        ansz.h(jArr9, jArr9);
                        ansz.b(jArr, jArr9, jArr);
                        ansz.b(jArr, jArr, jArr8);
                        ansz.b(jArr, jArr, jArr4);
                        ansz.h(jArr6, jArr);
                        ansz.b(jArr6, jArr6, jArr5);
                        ansz.i(jArr7, jArr6, jArr4);
                        if (ansu.e(jArr7)) {
                            ansz.j(jArr7, jArr6, jArr4);
                            if (!ansu.e(jArr7)) {
                                ansz.b(jArr, jArr, ansv.c);
                            } else {
                        ...
                        if (ansu.a(jArr) == ((c3[c] & b) >> i)) {
                            ansu.d(jArr, jArr);
                        }
                        ansz.b(jArr3, jArr, l);
                        ansy ansyVar = new ansy(new asqe(jArr, l, jArr2), jArr3);
                        anst[] anstVarArr = new anst[8];
                        anstVarArr[0] = new anst(ansyVar);
                        ansy ansyVar2 = new ansy(new asqe(), new long[10], (char[]) null);
                        ansu.k(ansyVar2, (asqe) ansyVar.a);
                        ansy ansyVar3 = new ansy(ansyVar2);
                        for (int i13 = 1; i13 < 8; i13++) {
                            ansu.i(ansyVar2, ansyVar3, anstVarArr[i13 - 1]);
                            anstVarArr[i13] = new anst(new ansy(ansyVar2));
                        }
                        byte[] h = ansu.h(digest);
                        byte[] h2 = ansu.h(copyOfRange);
                        ansy ansyVar4 = new ansy(ansu.b, (byte[]) null);
                        ansy ansyVar5 = new ansy();
                        int i14 = b;
                        while (i14 >= 0 && h[i14] == 0 && h2[i14] == 0) {
                            i14--;
                        }
                        while (i14 >= 0) {
                            ansu.k(ansyVar4, new asqe(ansyVar4));
                            byte b14 = h[i14];
                            if (b14 > 0) {
                                ansy.c(ansyVar5, ansyVar4);
                                b2 = 2;
                                ansu.i(ansyVar4, ansyVar5, anstVarArr[h[i14] / 2]);
                            } else {
                                b2 = 2;
                                if (b14 < 0) {
                                    ansy.c(ansyVar5, ansyVar4);
                                    ansu.j(ansyVar4, ansyVar5, anstVarArr[(-h[i14]) / 2]);
                                }
                            }
                            byte b15 = h2[i14];
                            if (b15 > 0) {
                                ansy.c(ansyVar5, ansyVar4);
                                ansu.i(ansyVar4, ansyVar5, ansv.e[h2[i14] / b2]);
                            } else if (b15 < 0) {
                                ansy.c(ansyVar5, ansyVar4);
                                ansu.j(ansyVar4, ansyVar5, ansv.e[(-h2[i14]) / b2]);
                            }
                            i14--;
                        }
                        byte[] l2 = new asqe(ansyVar4).l();
    ...
    /* JADX WARN: Type inference failed for: r0v11, types: [java.lang.Object, annh] */
    /* JADX WARN: Type inference failed for: r0v12, types: [java.lang.Object, annh] */
    ...
    public final void a(byte[] bArr, byte[] bArr2) {
        ...
        if (anuk.e(bArr5, bArr)) {
            byte[] bArr6 = this.b;
            if (bArr6.length != 0) {
                bArr2 = aode.O(bArr2, bArr6);
            }
    ...
    public aobh(byte[] bArr, byte[] bArr2, byte[] bArr3, int i) {
        this.c = i;
        if (anme.z(1)) {
            if (bArr.length == 32) {
                this.d = aocj.b(bArr);
