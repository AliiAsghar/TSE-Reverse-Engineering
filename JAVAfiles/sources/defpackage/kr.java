...
class kr {
    ...
    public kr(ProgressBar progressBar) {
        this.c = progressBar;
    }
    ...
    public void b(AttributeSet attributeSet, int i) {
        ktk A = ktk.A(this.c.getContext(), attributeSet, b, i, 0);
        Drawable q = A.q(0);
        if (q != null) {
            ProgressBar progressBar = this.c;
            if (q instanceof AnimationDrawable) {
                AnimationDrawable animationDrawable = (AnimationDrawable) q;
                ...
                q = animationDrawable2;
            }
            progressBar.setIndeterminateDrawable(q);
        }
        Drawable q2 = A.q(1);
        if (q2 != null) {
            this.c.setProgressDrawable(a(q2, false));
        }
        A.t();
    }
}
