...
public final class asqj extends asql {
    private final asqn a;

    public asqj(asqn asqnVar) {
        this.a = asqnVar;
    }

    private static final boolean b(X509Certificate x509Certificate, X509Certificate x509Certificate2) {
        if (!d.F(x509Certificate.getIssuerDN(), x509Certificate2.getSubjectDN())) {
            return false;
        }
        try {
    ...
    public final List a(List list, String str) {
        ...
        for (int i = 0; i < 9; i++) {
            ...
            if (a != null) {
                if (arrayList.size() > 1 || !d.F(x509Certificate, a)) {
                    arrayList.add(a);
                }
                if (!b(a, a)) {
                    z = true;
    ...
    public final boolean equals(Object obj) {
        ...
        if ((obj instanceof asqj) && d.F(((asqj) obj).a, this.a)) {
            return true;
        }
        return false;
    }
