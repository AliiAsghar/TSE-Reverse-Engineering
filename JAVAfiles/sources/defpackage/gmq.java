...
public final class gmq extends gmr implements Animatable {
    public final gmo a;
    ...
    public static void a(AnimatedVectorDrawable animatedVectorDrawable, gmm gmmVar) {
        animatedVectorDrawable.registerAnimationCallback(gmmVar.a());
    }
    ...
    public final Drawable.ConstantState getConstantState() {
        Drawable drawable = this.e;
        if (drawable != null) {
            return new gmp(drawable.getConstantState());
        }
        return null;
    }
    ...
    public final void inflate(Resources resources, XmlPullParser xmlPullParser, AttributeSet attributeSet, Resources.Theme theme) {
        ...
        while (eventType != 1 && (xmlPullParser.getDepth() >= depth || eventType != 3)) {
            if (eventType == 2) {
                ...
                if ("animated-vector".equals(name)) {
                    TypedArray g = dyv.g(resources, theme, attributeSet, gmk.e);
                    int resourceId = g.getResourceId(0, 0);
                    if (resourceId != 0) {
                        gmz b = gmz.b(resources, resourceId, theme);
                        b.c = false;
                        b.setCallback(this.d);
                        gmz gmzVar = this.a.b;
                        if (gmzVar != null) {
                            gmzVar.setCallback(null);
                        }
                        this.a.b = b;
                    }
                    g.recycle();
                } else if (GroupManagementRequest.TARGET_ATTRIBUTE.equals(name)) {
                    TypedArray obtainAttributes = resources.obtainAttributes(attributeSet, gmk.f);
        ...
        gmo gmoVar2 = this.a;
        if (gmoVar2.c == null) {
            gmoVar2.c = new AnimatorSet();
        }
        gmoVar2.c.playTogether(gmoVar2.d);
    }
}
