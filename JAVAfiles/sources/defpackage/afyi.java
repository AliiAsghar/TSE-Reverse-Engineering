...
public class afyi extends cg implements apxr {
    ...
    protected final void d() {
        if (!this.e) {
            ...
            kqm kqmVar = (kqm) aS();
            hugoHostFragment.b = (afxz) kqmVar.F.b();
            hugoHostFragment.c = (arwe) kqmVar.e.b();
            hugoHostFragment.d = Optional.of((afyk) kqmVar.be.b());
            hugoHostFragment.e = kqmVar.bf;
        }
    }
