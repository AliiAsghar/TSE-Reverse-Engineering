...
final class athf {
    ...
    private athf(Locale locale) {
        DateFormatSymbols b = atfz.b(locale);
        this.a = b.getEras();
    ...
    public static athf a(Locale locale) {
        if (locale == null) {
            locale = Locale.getDefault();
        }
        ConcurrentMap concurrentMap = n;
        athf athfVar = (athf) concurrentMap.get(locale);
        if (athfVar == null) {
            athfVar = new athf(locale);
            athf athfVar2 = (athf) concurrentMap.putIfAbsent(locale, athfVar);
            if (athfVar2 != null) {
                return athfVar2;
            }
        }
