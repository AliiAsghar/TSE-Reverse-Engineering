...
public final class lrg extends lrj implements akkh, apxq, akkf, aklk, akrw {
    private lrh aj;
    private Context ak;
    ...
    @Override // defpackage.lrj, defpackage.aiua, defpackage.cg
    ...
    public final void aN(Bundle bundle) {
        lrh E = E();
        E.b.fR(R.xml.etouffee_toggle_preferences);
        lrg lrgVar = E.b;
        E.h = Optional.ofNullable((TwoStatePreference) lrgVar.a(lrgVar.S(R.string.user_etouffee_toggle_pref_key)));
        aohs aohsVar = (aohs) E.c.b();
        usk uskVar = (usk) E.g.b();
        aohsVar.D(new akfk((ansy) uskVar.c, new ikn(uskVar, 8), "user_etouffee_enabled_setting_data_service", 2), akgd.FEW_SECONDS, E.i);
        E.h.ifPresent(new leq(E, 8));
    }
    ...
    @Override // defpackage.lrj, defpackage.cg
            ...
            if (!this.ao) {
                ...
                if (this.aj == null) {
                    try {
                        ...
                        if (cgVar instanceof lrg) {
                            lrg lrgVar = (lrg) cgVar;
                            krv krvVar = ((kqm) aS).a;
                            this.aj = new lrh(lrgVar, krvVar.kI, ((kqm) aS).r, ((kqm) aS).o, ((kqm) aS).R, krvVar.nt);
                            this.Z.c(new akli(this.an, this.al));
                        } else {
                            throw new IllegalStateException(hht.e(cgVar, lrh.class));
                        }
