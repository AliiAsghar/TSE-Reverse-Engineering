...
public final class aqiy implements aojy {
    public final alog p;
    public final alpt q;
    private final alor t;
    public static final ahka a = new ahka("google.internal.communications.instantmessaging.v1.Messaging.");
    private static final ahka r = new ahka("google.internal.communications.instantmessaging.v1.Messaging/");
    public static final aojx b = new aqiw(10, (int[][]) null);
    public static final aojx c = new aqiw(11, (boolean[][]) null);
    public static final aojx d = new aqiw(12, (float[][]) null);
    public static final aojx e = new aqiw(13, (byte[][][]) null);
    public static final aojx f = new aqiw(14, (char[][][]) null);
    public static final aojx g = new aqiw(15, (short[][][]) null);
    public static final aojx h = new aqiw(16, (int[][][]) null);
    public static final aojx i = new aqiw(17, (boolean[][][]) null);
    public static final aojx j = new aqiw(18, (float[][][]) null);
    public static final aojx k = new aqiw(6, (float[]) null);
    public static final aojx l = new aqiw(7, (byte[][]) null);
    public static final aojx m = new aqiw(8, (char[][]) null);
    public static final aojx n = new aqiw(9, (short[][]) null);
    public static final aqiy o = new aqiy();
    private static final ahka s = new ahka("instantmessaging-pa.googleapis.com");
    ...
    private aqiy() {
        ...
        aojx aojxVar12 = m;
        aojx aojxVar13 = n;
        alpt.v(aojxVar, aojxVar2, aojxVar3, aojxVar4, aojxVar5, aojxVar6, aojxVar7, aojxVar8, aojxVar9, aojxVar10, aojxVar11, aojxVar12, aojxVar13);
        alok alokVar = new alok();
        alokVar.h("SendMessage", aojxVar);
        alokVar.h("SendMessageExpress", aojxVar2);
        alokVar.h("Bind", aojxVar3);
        alokVar.h("ReceiveMessages", aojxVar4);
        alokVar.h("ReceiveMessagesExpress", aojxVar5);
        alokVar.h("PullMessages", aojxVar6);
        alokVar.h("AckMessages", aojxVar7);
        alokVar.h("BatchAckMessages", aojxVar8);
        alokVar.h("RevokeMessagesById", aojxVar9);
        alokVar.h("RevokeMessagesBySender", aojxVar10);
        alokVar.h("PrewarmReceiver", aojxVar11);
        alokVar.h("Echo", aojxVar12);
        alokVar.h("CreateMlsConversation", aojxVar13);
        this.t = alokVar.b();
        new alok().b();
    }
    ...
    public final aojx b(String str) {
        ...
        if (str.startsWith(str2)) {
            ...
            if (this.t.containsKey(substring)) {
                return (aojx) this.t.get(substring);
            }
            return null;
        }
        return null;
