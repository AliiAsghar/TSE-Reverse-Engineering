...
public final class ad extends ViewGroup.MarginLayoutParams {
    ...
    public ad(Context context, AttributeSet attributeSet) {
        ...
        this.X = 0.5f;
        this.Y = new an();
        TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, ag.a);
        ...
        for (int i2 = 0; i2 < indexCount; i2++) {
            ...
            if (index == 84) {
                ...
                this.A = obtainStyledAttributes.getFloat(82, brg.a);
            } else if (index == 97) {
                this.B = obtainStyledAttributes.getFloat(97, brg.a);
            } else if (index == 81) {
