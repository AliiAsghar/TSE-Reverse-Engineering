...
public final class hgv implements hho {
    private int a;
    ...
    public final /* bridge */ /* synthetic */ Object a(hhr hhrVar, float f) {
        ...
        while (hhrVar.n()) {
            arrayList.add(Float.valueOf((float) hhrVar.a()));
        }
        int i3 = 2;
        if (arrayList.size() == 4 && ((Float) arrayList.get(0)).floatValue() == 1.0f) {
            arrayList.set(0, Float.valueOf(brg.a));
        ...
        ico icoVar = new ico(fArr, iArr, (short[]) null);
        if (arrayList.size() > i) {
            Object obj2 = icoVar.a;
            Object obj3 = icoVar.b;
            ...
            while (i16 < length2) {
                ...
                if (binarySearch >= 0 && binarySearch2 <= 0) {
                    ...
                    if (iArr3.length >= 2 && f7 != fArr7[0]) {
                        ...
                        i2 = Color.argb((int) (f14 * 255.0f), gvf.S(f16, Color.red(i23), Color.red(i22)), gvf.S(f16, Color.green(i23), Color.green(i22)), gvf.S(f16, Color.blue(i23), Color.blue(i22)));
                        z = false;
                    } else {
                        z = false;
                        i2 = iArr3[0];
            ...
            return new ico(fArr4, iArr2, (short[]) null);
        }
        return icoVar;
    }
}
