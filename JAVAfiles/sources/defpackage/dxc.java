...
public final class dxc extends ViewGroup.MarginLayoutParams {
    public int A;
    public int B;
    public int C;
    public int D;
    ...
    public final void a() {
        ...
        this.ae = true;
        this.af = true;
        if (!(this.av instanceof dwg)) {
            this.av = new dwg();
        }
        ((dwg) this.av).ag(this.Z);
    }
    ...
    */
    public final void resolveLayoutDirection(int r11) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.dxc.resolveLayoutDirection(int):void");
    }
    ...
    public dxc(Context context, AttributeSet attributeSet) {
        ...
        this.av = new dwc();
        this.aw = false;
        TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, dxp.b);
        int indexCount = obtainStyledAttributes.getIndexCount();
        for (int i = 0; i < indexCount; i++) {
            int index = obtainStyledAttributes.getIndex(i);
            int i2 = dxb.a.get(index);
            switch (i2) {
                case 1:
                ...
                case IGmsServiceBroker.Stub.TRANSACTION_GET_SEARCH_CORPORA_SERVICE /* 35 */:
                    this.V = Math.max(brg.a, obtainStyledAttributes.getFloat(index, this.V));
                    this.P = 2;
                    break;
                ...
                case IGmsServiceBroker.Stub.TRANSACTION_GET_REMINDERS_SERVICE /* 38 */:
                    this.W = Math.max(brg.a, obtainStyledAttributes.getFloat(index, this.W));
                    this.Q = 2;
                    break;
                default:
                    switch (i2) {
                        case IGmsServiceBroker.Stub.TRANSACTION_GET_DEVICE_CONNECTION_SERVICE /* 44 */:
                            dxl.j(this, obtainStyledAttributes.getString(index));
                            break;
                        ...
                        default:
                            switch (i2) {
                                case 64:
                                    dxl.i(this, obtainStyledAttributes, index, 0);
                                    this.E = true;
                                    break;
                                case 65:
                                    dxl.i(this, obtainStyledAttributes, index, 1);
                                    this.F = true;
                                    break;
                                case 66:
    ...
    public dxc(ViewGroup.LayoutParams layoutParams) {
        super(layoutParams);
        this.a = -1;
        this.b = -1;
        this.c = -1.0f;
        ...
        this.av = new dwc();
        this.aw = false;
        if (layoutParams instanceof dxc) {
            dxc dxcVar = (dxc) layoutParams;
            this.a = dxcVar.a;
            this.b = dxcVar.b;
            this.c = dxcVar.c;
            this.d = dxcVar.d;
