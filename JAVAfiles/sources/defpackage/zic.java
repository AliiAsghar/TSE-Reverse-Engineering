...
public final class zic extends zna implements akkh, apxq, akkf, aklk, akrw {
    private zid a;
    private boolean ag;
    private Context d;
    ...
    public final View K(LayoutInflater layoutInflater, ViewGroup viewGroup, Bundle bundle) {
        ...
        try {
            ...
            View inflate = layoutInflater.inflate(R.layout.sim_settings_fragment, viewGroup, false);
            ((akgu) E.c.b()).a(R.id.get_sim_selection_settings_data_source, new xph((zib) E.d.b(), 3), new zhq(new wup(E, inflate, 14, null), 2));
            akqj.p();
            return inflate;
        } catch (Throwable th) {
            try {
    ...
    @Override // defpackage.zna, defpackage.aiuc, defpackage.cg
    ...
    @Override // defpackage.zna, defpackage.aklf, defpackage.cg
        ...
        try {
            if (!this.ag) {
                ...
                if (this.a == null) {
                    try {
                        Object aS = aS();
                        this.a = new zid((cg) ((apxx) ((kql) aS).d).a, ((kql) aS).dV, ((kql) aS).dW);
    ...
    @Override // defpackage.zna, defpackage.cg
