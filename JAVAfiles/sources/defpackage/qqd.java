...
public final class qqd extends aglz {
    ...
    public final /* bridge */ /* synthetic */ void c(agmq agmqVar) {
        ...
        if (qqgVar.db(1)) {
            this.b = qqgVar.getInt(qqgVar.cI(1, qql.a));
            fE(1);
        }
        if (qqgVar.db(2)) {
            if (qqgVar.getInt(qqgVar.cI(2, qql.a)) == 1) {
                z = true;
            }
            this.c = z;
            fE(2);
        ...
        if (qqgVar.db(3)) {
            this.d = agnc.y(null, qqg.dl(qqgVar.getString(qqgVar.cI(3, qql.a))));
            fE(3);
        }
        if (qqgVar.db(4)) {
            this.e = agnc.y(null, qqg.dl(qqgVar.getString(qqgVar.cI(4, qql.a))));
            fE(4);
        }
        if (qqgVar.db(5)) {
            this.f = qqgVar.getString(qqgVar.cI(5, qql.a));
            fE(5);
        }
        if (qqgVar.db(6)) {
            this.g = qqgVar.e();
        ...
        if (qqgVar.db(8)) {
            this.i = agnc.y(null, qqg.dl(qqgVar.getString(qqgVar.cI(8, qql.a))));
            fE(8);
        }
    }
    ...
    public final boolean equals(Object obj) {
        ...
        qqd qqdVar = (qqd) obj;
        if (super.aC(qqdVar.cJ) && Objects.equals(this.a, qqdVar.a) && this.b == qqdVar.b && this.c == qqdVar.c && Arrays.equals(this.d, qqdVar.d) && Arrays.equals(this.e, qqdVar.e) && Objects.equals(this.f, qqdVar.f) && Arrays.equals(this.g, qqdVar.g) && Arrays.equals(this.h, qqdVar.h) && Arrays.equals(this.i, qqdVar.i)) {
            return true;
        }
        return false;
    }
